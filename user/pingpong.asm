...
int main(int argc, char *argv[])
{
   ...
   8:	0880                	addi	s0,sp,80
    ...
    //创建管道
    pipe(fds_cp);
   a:	fb040513          	addi	a0,s0,-80
   e:	00000097          	auipc	ra,0x0
  12:	376080e7          	jalr	886(ra) # 384 <pipe>
    pipe(fds_pc);
  16:	fb840513          	addi	a0,s0,-72
  1a:	00000097          	auipc	ra,0x0
  1e:	36a080e7          	jalr	874(ra) # 384 <pipe>

    int pid;
    pid = fork(); //fork子进程
  22:	00000097          	auipc	ra,0x0
  26:	34a080e7          	jalr	842(ra) # 36c <fork>
    //子进程部分
    if (pid == 0)
  ...
  2c:	fb042503          	lw	a0,-80(s0)
  30:	00000097          	auipc	ra,0x0
  34:	36c080e7          	jalr	876(ra) # 39c <close>
        //通信方向：父到子，子不需要写
        close(fds_pc[INDEX_WRITE]);
  38:	fbc42503          	lw	a0,-68(s0)
  3c:	00000097          	auipc	ra,0x0
  40:	360080e7          	jalr	864(ra) # 39c <close>

        //2：子进程收到ping指令，打印
        char buf[BUFFER_SIZE];
        if (read(fds_pc[INDEX_READ], buf, 1) == 1)
  44:	4605                	li	a2,1
  46:	fd040593          	addi	a1,s0,-48
  4a:	fb842503          	lw	a0,-72(s0)
  4e:	00000097          	auipc	ra,0x0
  52:	33e080e7          	jalr	830(ra) # 38c <read>
  56:	4785                	li	a5,1
  58:	02f50263          	beq	a0,a5,7c <main+0x7c>
        {
  ...
  62:	84a58593          	addi	a1,a1,-1974 # 8a8 <malloc+0x102>
  66:	fb442503          	lw	a0,-76(s0)
  6a:	00000097          	auipc	ra,0x0
  6e:	32a080e7          	jalr	810(ra) # 394 <write>

        exit(0);
  72:	4501                	li	a0,0
  74:	00000097          	auipc	ra,0x0
  78:	300080e7          	jalr	768(ra) # 374 <exit>
            printf("%d: received ping\n", getpid());
  7c:	00000097          	auipc	ra,0x0
  80:	378080e7          	jalr	888(ra) # 3f4 <getpid>
  84:	85aa                	mv	a1,a0
  86:	00001517          	auipc	a0,0x1
  8a:	80a50513          	addi	a0,a0,-2038 # 890 <malloc+0xea>
  8e:	00000097          	auipc	ra,0x0
  92:	660080e7          	jalr	1632(ra) # 6ee <printf>
  96:	b7d9                	j	5c <main+0x5c>
    }
    //父进程部分
    else
    {
  ...
  9a:	fb442503          	lw	a0,-76(s0)
  9e:	00000097          	auipc	ra,0x0
  a2:	2fe080e7          	jalr	766(ra) # 39c <close>
        //通信方向：父到子，父不需要读
        close(fds_pc[INDEX_READ]);
  a6:	fb842503          	lw	a0,-72(s0)
  aa:	00000097          	auipc	ra,0x0
  ae:	2f2080e7          	jalr	754(ra) # 39c <close>

        //1: 父进程给子进程发ping
        write(fds_pc[INDEX_WRITE], "f", 1);
  b2:	4605                	li	a2,1
  b4:	00000597          	auipc	a1,0x0
  b8:	7f458593          	addi	a1,a1,2036 # 8a8 <malloc+0x102>
  bc:	fbc42503          	lw	a0,-68(s0)
  c0:	00000097          	auipc	ra,0x0
  c4:	2d4080e7          	jalr	724(ra) # 394 <write>

        //4：父进程读取子进程发出的ping
        char buf[BUFFER_SIZE];
        if (read(fds_cp[INDEX_READ], buf, 1) == 1)
  c8:	4605                	li	a2,1
  ca:	fc040593          	addi	a1,s0,-64
  ce:	fb042503          	lw	a0,-80(s0)
  d2:	00000097          	auipc	ra,0x0
  d6:	2ba080e7          	jalr	698(ra) # 38c <read>
  da:	4785                	li	a5,1
  dc:	00f50863          	beq	a0,a5,ec <main+0xec>
  e0:	8126                	mv	sp,s1
  ...
  e8:	290080e7          	jalr	656(ra) # 374 <exit>
            printf("%d: received pong\n", getpid());
  ec:	00000097          	auipc	ra,0x0
  f0:	308080e7          	jalr	776(ra) # 3f4 <getpid>
  f4:	85aa                	mv	a1,a0
  f6:	00000517          	auipc	a0,0x0
  fa:	7ba50513          	addi	a0,a0,1978 # 8b0 <malloc+0x10a>
  fe:	00000097          	auipc	ra,0x0
 102:	5f0080e7          	jalr	1520(ra) # 6ee <printf>
...
putc(int fd, char c)
{
 ...
 42a:	f6e080e7          	jalr	-146(ra) # 394 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45c:	4d050513          	addi	a0,a0,1232 # 928 <digits>
 460:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51c:	3b8c8c93          	addi	s9,s9,952 # 8d0 <malloc+0x12a>
 ...
 52a:	402b8b93          	addi	s7,s7,1026 # 928 <digits>
 ...
 650:	27c98993          	addi	s3,s3,636 # 8c8 <malloc+0x122>
        while(*s != 0){
 654:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 732:	21a7b783          	ld	a5,538(a5) # 948 <freep>
 ...
 75a:	00e6ea63          	bltu	a3,a4,76e <free+0x4a>
{
 ...
 79c:	1af73823          	sd	a5,432(a4) # 948 <freep>
}
 7a0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7ce:	17e53503          	ld	a0,382(a0) # 948 <freep>
 ...
 7f6:	15690913          	addi	s2,s2,342 # 948 <freep>
  if(p == (char*)-1)
 7fa:	5afd                	li	s5,-1
 7fc:	a895                	j	870 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7fe:	00000797          	auipc	a5,0x0
 802:	15278793          	addi	a5,a5,338 # 950 <base>
 806:	00000717          	auipc	a4,0x0
 80a:	14f73123          	sd	a5,322(a4) # 948 <freep>
 80e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 832:	10a73d23          	sd	a0,282(a4) # 948 <freep>
      return (void*)(p + 1);
 ...
 880:	b80080e7          	jalr	-1152(ra) # 3fc <sbrk>
  if(p == (char*)-1)

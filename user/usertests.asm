...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	da250513          	addi	a0,a0,-606 # 5de0 <statistics+0x86>
      46:	00006097          	auipc	ra,0x6
      4a:	b76080e7          	jalr	-1162(ra) # 5bbc <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	71878793          	addi	a5,a5,1816 # 9770 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	e2068693          	addi	a3,a3,-480 # be80 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	d8050513          	addi	a0,a0,-640 # 5e00 <statistics+0xa6>
      88:	00006097          	auipc	ra,0x6
      8c:	b34080e7          	jalr	-1228(ra) # 5bbc <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d7050513          	addi	a0,a0,-656 # 5e18 <statistics+0xbe>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d7250513          	addi	a0,a0,-654 # 5e38 <statistics+0xde>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	d3a50513          	addi	a0,a0,-710 # 5e20 <statistics+0xc6>
      ee:	00006097          	auipc	ra,0x6
      f2:	ace080e7          	jalr	-1330(ra) # 5bbc <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	d4650513          	addi	a0,a0,-698 # 5e48 <statistics+0xee>
     10a:	00006097          	auipc	ra,0x6
     10e:	ab2080e7          	jalr	-1358(ra) # 5bbc <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	d4450513          	addi	a0,a0,-700 # 5e70 <statistics+0x116>
     134:	00005097          	auipc	ra,0x5
     138:	75e080e7          	jalr	1886(ra) # 5892 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	d3050513          	addi	a0,a0,-720 # 5e70 <statistics+0x116>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	d2c58593          	addi	a1,a1,-724 # 5e80 <statistics+0x126>
     15c:	00005097          	auipc	ra,0x5
     160:	706080e7          	jalr	1798(ra) # 5862 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	d0850513          	addi	a0,a0,-760 # 5e70 <statistics+0x116>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	d0c58593          	addi	a1,a1,-756 # 5e88 <statistics+0x12e>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	cdc50513          	addi	a0,a0,-804 # 5e70 <statistics+0x116>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	cc650513          	addi	a0,a0,-826 # 5e90 <statistics+0x136>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	9ea080e7          	jalr	-1558(ra) # 5bbc <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	c3c50513          	addi	a0,a0,-964 # 5eb8 <statistics+0x15e>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	c28a8a93          	addi	s5,s5,-984 # 5eb8 <statistics+0x15e>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	be8a0a13          	addi	s4,s4,-1048 # be80 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	bb650513          	addi	a0,a0,-1098 # 5ec8 <statistics+0x16e>
     31a:	00006097          	auipc	ra,0x6
     31e:	8a2080e7          	jalr	-1886(ra) # 5bbc <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	bb450513          	addi	a0,a0,-1100 # 5ee8 <statistics+0x18e>
     33c:	00006097          	auipc	ra,0x6
     340:	880080e7          	jalr	-1920(ra) # 5bbc <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	b90a0a13          	addi	s4,s4,-1136 # 5f00 <statistics+0x1a6>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	aec50513          	addi	a0,a0,-1300 # 5f08 <statistics+0x1ae>
     424:	00005097          	auipc	ra,0x5
     428:	798080e7          	jalr	1944(ra) # 5bbc <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	ae650513          	addi	a0,a0,-1306 # 5f20 <statistics+0x1c6>
     442:	00005097          	auipc	ra,0x5
     446:	77a080e7          	jalr	1914(ra) # 5bbc <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	af850513          	addi	a0,a0,-1288 # 5f50 <statistics+0x1f6>
     460:	00005097          	auipc	ra,0x5
     464:	75c080e7          	jalr	1884(ra) # 5bbc <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	b0e50513          	addi	a0,a0,-1266 # 5f80 <statistics+0x226>
     47a:	00005097          	auipc	ra,0x5
     47e:	742080e7          	jalr	1858(ra) # 5bbc <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	b0050513          	addi	a0,a0,-1280 # 5f90 <statistics+0x236>
     498:	00005097          	auipc	ra,0x5
     49c:	724080e7          	jalr	1828(ra) # 5bbc <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	af2a0a13          	addi	s4,s4,-1294 # 5fc0 <statistics+0x266>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	9b2a8a93          	addi	s5,s5,-1614 # 5e88 <statistics+0x12e>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	a4c50513          	addi	a0,a0,-1460 # 5fc8 <statistics+0x26e>
     584:	00005097          	auipc	ra,0x5
     588:	638080e7          	jalr	1592(ra) # 5bbc <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	a4650513          	addi	a0,a0,-1466 # 5fe0 <statistics+0x286>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	61a080e7          	jalr	1562(ra) # 5bbc <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	9cc50513          	addi	a0,a0,-1588 # 5f80 <statistics+0x226>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	600080e7          	jalr	1536(ra) # 5bbc <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	a4250513          	addi	a0,a0,-1470 # 6010 <statistics+0x2b6>
     5d6:	00005097          	auipc	ra,0x5
     5da:	5e6080e7          	jalr	1510(ra) # 5bbc <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	a3c50513          	addi	a0,a0,-1476 # 6028 <statistics+0x2ce>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	5c8080e7          	jalr	1480(ra) # 5bbc <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	83e58593          	addi	a1,a1,-1986 # 5e80 <statistics+0x126>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	81250513          	addi	a0,a0,-2030 # 5e70 <statistics+0x116>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	7e650513          	addi	a0,a0,2022 # 5e70 <statistics+0x116>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	7d250513          	addi	a0,a0,2002 # 5e70 <statistics+0x116>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	9dc58593          	addi	a1,a1,-1572 # 60b8 <statistics+0x35e>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	75250513          	addi	a0,a0,1874 # 5e70 <statistics+0x116>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	8f650513          	addi	a0,a0,-1802 # 6058 <statistics+0x2fe>
     76a:	00005097          	auipc	ra,0x5
     76e:	452080e7          	jalr	1106(ra) # 5bbc <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	8fa50513          	addi	a0,a0,-1798 # 6078 <statistics+0x31e>
     786:	00005097          	auipc	ra,0x5
     78a:	436080e7          	jalr	1078(ra) # 5bbc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	8f650513          	addi	a0,a0,-1802 # 6088 <statistics+0x32e>
     79a:	00005097          	auipc	ra,0x5
     79e:	422080e7          	jalr	1058(ra) # 5bbc <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	8fa50513          	addi	a0,a0,-1798 # 60a8 <statistics+0x34e>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c6:	8c650513          	addi	a0,a0,-1850 # 6088 <statistics+0x32e>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	3f2080e7          	jalr	1010(ra) # 5bbc <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	8e050513          	addi	a0,a0,-1824 # 60c0 <statistics+0x366>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	3d4080e7          	jalr	980(ra) # 5bbc <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	8e250513          	addi	a0,a0,-1822 # 60e0 <statistics+0x386>
     806:	00005097          	auipc	ra,0x5
     80a:	3b6080e7          	jalr	950(ra) # 5bbc <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	8ce50513          	addi	a0,a0,-1842 # 6100 <statistics+0x3a6>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	8de98993          	addi	s3,s3,-1826 # 6128 <statistics+0x3ce>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	90ea8a93          	addi	s5,s5,-1778 # 6160 <statistics+0x406>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	86850513          	addi	a0,a0,-1944 # 6100 <statistics+0x3a6>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	5ce58593          	addi	a1,a1,1486 # be80 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	82c50513          	addi	a0,a0,-2004 # 6100 <statistics+0x3a6>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	80a50513          	addi	a0,a0,-2038 # 6108 <statistics+0x3ae>
     906:	00005097          	auipc	ra,0x5
     90a:	2b6080e7          	jalr	694(ra) # 5bbc <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	81c50513          	addi	a0,a0,-2020 # 6138 <statistics+0x3de>
     924:	00005097          	auipc	ra,0x5
     928:	298080e7          	jalr	664(ra) # 5bbc <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	83650513          	addi	a0,a0,-1994 # 6170 <statistics+0x416>
     942:	00005097          	auipc	ra,0x5
     946:	27a080e7          	jalr	634(ra) # 5bbc <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	84250513          	addi	a0,a0,-1982 # 6198 <statistics+0x43e>
     95e:	00005097          	auipc	ra,0x5
     962:	25e080e7          	jalr	606(ra) # 5bbc <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	84650513          	addi	a0,a0,-1978 # 61b8 <statistics+0x45e>
     97a:	00005097          	auipc	ra,0x5
     97e:	242080e7          	jalr	578(ra) # 5bbc <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	84250513          	addi	a0,a0,-1982 # 61d0 <statistics+0x476>
     996:	00005097          	auipc	ra,0x5
     99a:	226080e7          	jalr	550(ra) # 5bbc <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	83050513          	addi	a0,a0,-2000 # 61f0 <statistics+0x496>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	4ac90913          	addi	s2,s2,1196 # be80 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	7de50513          	addi	a0,a0,2014 # 61f0 <statistics+0x496>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	45a90913          	addi	s2,s2,1114 # be80 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	79e50513          	addi	a0,a0,1950 # 61f8 <statistics+0x49e>
     a62:	00005097          	auipc	ra,0x5
     a66:	15a080e7          	jalr	346(ra) # 5bbc <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	7a050513          	addi	a0,a0,1952 # 6218 <statistics+0x4be>
     a80:	00005097          	auipc	ra,0x5
     a84:	13c080e7          	jalr	316(ra) # 5bbc <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	7ac50513          	addi	a0,a0,1964 # 6240 <statistics+0x4e6>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	120080e7          	jalr	288(ra) # 5bbc <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	73050513          	addi	a0,a0,1840 # 61f0 <statistics+0x496>
     ...
     af0:	77450513          	addi	a0,a0,1908 # 6260 <statistics+0x506>
     af4:	00005097          	auipc	ra,0x5
     af8:	0c8080e7          	jalr	200(ra) # 5bbc <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	77e50513          	addi	a0,a0,1918 # 6288 <statistics+0x52e>
     b12:	00005097          	auipc	ra,0x5
     b16:	0aa080e7          	jalr	170(ra) # 5bbc <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	77850513          	addi	a0,a0,1912 # 62a0 <statistics+0x546>
     b30:	00005097          	auipc	ra,0x5
     b34:	08c080e7          	jalr	140(ra) # 5bbc <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	78450513          	addi	a0,a0,1924 # 62c8 <statistics+0x56e>
     b4c:	00005097          	auipc	ra,0x5
     b50:	070080e7          	jalr	112(ra) # 5bbc <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	76e50513          	addi	a0,a0,1902 # 62e0 <statistics+0x586>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	78658593          	addi	a1,a1,1926 # 6310 <statistics+0x5b6>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	73a50513          	addi	a0,a0,1850 # 62e0 <statistics+0x586>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	72450513          	addi	a0,a0,1828 # 62e0 <statistics+0x586>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	70e50513          	addi	a0,a0,1806 # 62e0 <statistics+0x586>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	77258593          	addi	a1,a1,1906 # 6358 <statistics+0x5fe>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	27e58593          	addi	a1,a1,638 # be80 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	69250513          	addi	a0,a0,1682 # 62e0 <statistics+0x586>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	68250513          	addi	a0,a0,1666 # 62f0 <statistics+0x596>
     c76:	00005097          	auipc	ra,0x5
     c7a:	f46080e7          	jalr	-186(ra) # 5bbc <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	68e50513          	addi	a0,a0,1678 # 6318 <statistics+0x5be>
     c92:	00005097          	auipc	ra,0x5
     c96:	f2a080e7          	jalr	-214(ra) # 5bbc <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	69250513          	addi	a0,a0,1682 # 6338 <statistics+0x5de>
     cae:	00005097          	auipc	ra,0x5
     cb2:	f0e080e7          	jalr	-242(ra) # 5bbc <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	69e50513          	addi	a0,a0,1694 # 6360 <statistics+0x606>
     cca:	00005097          	auipc	ra,0x5
     cce:	ef2080e7          	jalr	-270(ra) # 5bbc <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	6a250513          	addi	a0,a0,1698 # 6380 <statistics+0x626>
     ce6:	00005097          	auipc	ra,0x5
     cea:	ed6080e7          	jalr	-298(ra) # 5bbc <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	6a650513          	addi	a0,a0,1702 # 63a0 <statistics+0x646>
     d02:	00005097          	auipc	ra,0x5
     d06:	eba080e7          	jalr	-326(ra) # 5bbc <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	5b258593          	addi	a1,a1,1458 # 6310 <statistics+0x5b6>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	64a58593          	addi	a1,a1,1610 # 63c8 <statistics+0x66e>
     d86:	00005517          	auipc	a0,0x5
     d8a:	63a50513          	addi	a0,a0,1594 # 63c0 <statistics+0x666>
  ...
  unlink("lf1");
     ...
     d9e:	62650513          	addi	a0,a0,1574 # 63c0 <statistics+0x666>
     da2:	00005097          	auipc	ra,0x5
     da6:	af0080e7          	jalr	-1296(ra) # 5892 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	61450513          	addi	a0,a0,1556 # 63c0 <statistics+0x666>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	60650513          	addi	a0,a0,1542 # 63c8 <statistics+0x66e>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	0a658593          	addi	a1,a1,166 # be80 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	5ce58593          	addi	a1,a1,1486 # 63c8 <statistics+0x66e>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	5b850513          	addi	a0,a0,1464 # 63c8 <statistics+0x66e>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a7a080e7          	jalr	-1414(ra) # 5892 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	5a058593          	addi	a1,a1,1440 # 63c0 <statistics+0x666>
     e28:	00005517          	auipc	a0,0x5
     e2c:	5a050513          	addi	a0,a0,1440 # 63c8 <statistics+0x66e>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	58458593          	addi	a1,a1,1412 # 63c0 <statistics+0x666>
     e44:	00005517          	auipc	a0,0x5
     e48:	68c50513          	addi	a0,a0,1676 # 64d0 <statistics+0x776>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	56a50513          	addi	a0,a0,1386 # 63d0 <statistics+0x676>
     e6e:	00005097          	auipc	ra,0x5
     e72:	d4e080e7          	jalr	-690(ra) # 5bbc <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	56650513          	addi	a0,a0,1382 # 63e8 <statistics+0x68e>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	d32080e7          	jalr	-718(ra) # 5bbc <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	56250513          	addi	a0,a0,1378 # 6400 <statistics+0x6a6>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	d16080e7          	jalr	-746(ra) # 5bbc <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	56650513          	addi	a0,a0,1382 # 6420 <statistics+0x6c6>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	cfa080e7          	jalr	-774(ra) # 5bbc <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	57a50513          	addi	a0,a0,1402 # 6450 <statistics+0x6f6>
     ede:	00005097          	auipc	ra,0x5
     ee2:	cde080e7          	jalr	-802(ra) # 5bbc <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	57650513          	addi	a0,a0,1398 # 6468 <statistics+0x70e>
     efa:	00005097          	auipc	ra,0x5
     efe:	cc2080e7          	jalr	-830(ra) # 5bbc <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	57250513          	addi	a0,a0,1394 # 6480 <statistics+0x726>
     f16:	00005097          	auipc	ra,0x5
     f1a:	ca6080e7          	jalr	-858(ra) # 5bbc <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	57e50513          	addi	a0,a0,1406 # 64a8 <statistics+0x74e>
     f32:	00005097          	auipc	ra,0x5
     f36:	c8a080e7          	jalr	-886(ra) # 5bbc <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	59250513          	addi	a0,a0,1426 # 64d8 <statistics+0x77e>
     f4e:	00005097          	auipc	ra,0x5
     f52:	c6e080e7          	jalr	-914(ra) # 5bbc <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	54ca0a13          	addi	s4,s4,1356 # 64f8 <statistics+0x79e>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	4fa50513          	addi	a0,a0,1274 # 64f8 <statistics+0x79e>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	49250513          	addi	a0,a0,1170 # 6500 <statistics+0x7a6>
    1076:	00005097          	auipc	ra,0x5
    107a:	b46080e7          	jalr	-1210(ra) # 5bbc <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	49250513          	addi	a0,a0,1170 # 6520 <statistics+0x7c6>
    1096:	00005097          	auipc	ra,0x5
    109a:	b26080e7          	jalr	-1242(ra) # 5bbc <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	49650513          	addi	a0,a0,1174 # 6540 <statistics+0x7e6>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	b0a080e7          	jalr	-1270(ra) # 5bbc <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	48498993          	addi	s3,s3,1156 # 6560 <statistics+0x806>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	45850513          	addi	a0,a0,1112 # 6570 <statistics+0x816>
    1120:	00005097          	auipc	ra,0x5
    1124:	a9c080e7          	jalr	-1380(ra) # 5bbc <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	5184b483          	ld	s1,1304(s1) # 8658 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117a:	35048493          	addi	s1,s1,848 # c350 <buf+0x4d0>
  for(int i = 0; i < 50000; i++){
    ...
    1188:	c9498993          	addi	s3,s3,-876 # 5e18 <statistics+0xbe>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	55a78793          	addi	a5,a5,1370 # 7768 <statistics+0x1a0e>
  ...
  if(pid == 0){
    ...
    1248:	52478793          	addi	a5,a5,1316 # 8768 <big.0>
    124c:	00008697          	auipc	a3,0x8
    1250:	51c68693          	addi	a3,a3,1308 # 9768 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1266:	50078323          	sb	zero,1286(a5) # 9768 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126a:	00007797          	auipc	a5,0x7
    126e:	f3e78793          	addi	a5,a5,-194 # 81a8 <statistics+0x244e>
    ...
    1292:	b8a50513          	addi	a0,a0,-1142 # 5e18 <statistics+0xbe>
    ...
    12aa:	37250513          	addi	a0,a0,882 # 6618 <statistics+0x8be>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	90e080e7          	jalr	-1778(ra) # 5bbc <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	2ca50513          	addi	a0,a0,714 # 6590 <statistics+0x836>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	8ee080e7          	jalr	-1810(ra) # 5bbc <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	2ca50513          	addi	a0,a0,714 # 65b0 <statistics+0x856>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	8ce080e7          	jalr	-1842(ra) # 5bbc <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	2c850513          	addi	a0,a0,712 # 65d0 <statistics+0x876>
    1310:	00005097          	auipc	ra,0x5
    1314:	8ac080e7          	jalr	-1876(ra) # 5bbc <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	2d050513          	addi	a0,a0,720 # 65f8 <statistics+0x89e>
    ...
    1346:	74e50513          	addi	a0,a0,1870 # 6a90 <statistics+0xd36>
    134a:	00005097          	auipc	ra,0x5
    134e:	872080e7          	jalr	-1934(ra) # 5bbc <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	2b450513          	addi	a0,a0,692 # 6640 <statistics+0x8e6>
    1394:	00005097          	auipc	ra,0x5
    1398:	828080e7          	jalr	-2008(ra) # 5bbc <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	ab250513          	addi	a0,a0,-1358 # 5e70 <statistics+0x116>
  ...
  if(pid == 0){
    ...
    13ec:	a88a0a13          	addi	s4,s4,-1400 # 5e70 <statistics+0x116>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	2b0a8a93          	addi	s5,s5,688 # 66a0 <statistics+0x946>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	21050513          	addi	a0,a0,528 # 6670 <statistics+0x916>
    1468:	00004097          	auipc	ra,0x4
    146c:	754080e7          	jalr	1876(ra) # 5bbc <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	20c50513          	addi	a0,a0,524 # 6688 <statistics+0x92e>
    1484:	00004097          	auipc	ra,0x4
    1488:	738080e7          	jalr	1848(ra) # 5bbc <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	21650513          	addi	a0,a0,534 # 66b0 <statistics+0x956>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	71a080e7          	jalr	1818(ra) # 5bbc <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	9b8a0a13          	addi	s4,s4,-1608 # 5e70 <statistics+0x116>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	210a8a93          	addi	s5,s5,528 # 66d0 <statistics+0x976>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	96650513          	addi	a0,a0,-1690 # 5e70 <statistics+0x116>
  ...
  exit(xstatus);
    ...
    152c:	16050513          	addi	a0,a0,352 # 6688 <statistics+0x92e>
    1530:	00004097          	auipc	ra,0x4
    1534:	68c080e7          	jalr	1676(ra) # 5bbc <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	19250513          	addi	a0,a0,402 # 66d8 <statistics+0x97e>
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	8aa78793          	addi	a5,a5,-1878 # 5e18 <statistics+0xbe>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	17e78793          	addi	a5,a5,382 # 66f8 <statistics+0x99e>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	17650513          	addi	a0,a0,374 # 6700 <statistics+0x9a6>
  ...
  if(pid == 0) {
    ...
    15bc:	14850513          	addi	a0,a0,328 # 6700 <statistics+0x9a6>
    ...
    15d8:	14c50513          	addi	a0,a0,332 # 6720 <statistics+0x9c6>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	5e0080e7          	jalr	1504(ra) # 5bbc <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	08050513          	addi	a0,a0,128 # 6670 <statistics+0x916>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	5c4080e7          	jalr	1476(ra) # 5bbc <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	0fc50513          	addi	a0,a0,252 # 6708 <statistics+0x9ae>
    1614:	00004097          	auipc	ra,0x4
    1618:	5a8080e7          	jalr	1448(ra) # 5bbc <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	7ee50513          	addi	a0,a0,2030 # 5e18 <statistics+0xbe>
  ...
  if(xstatus != 0)
    ...
    1662:	0d250513          	addi	a0,a0,210 # 6730 <statistics+0x9d6>
    1666:	00004097          	auipc	ra,0x4
    166a:	556080e7          	jalr	1366(ra) # 5bbc <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	0ce50513          	addi	a0,a0,206 # 6748 <statistics+0x9ee>
    1682:	00004097          	auipc	ra,0x4
    1686:	53a080e7          	jalr	1338(ra) # 5bbc <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	07250513          	addi	a0,a0,114 # 6700 <statistics+0x9a6>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	b0050513          	addi	a0,a0,-1280 # 61b8 <statistics+0x45e>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	4fc080e7          	jalr	1276(ra) # 5bbc <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	fb450513          	addi	a0,a0,-76 # 6688 <statistics+0x92e>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	4e0080e7          	jalr	1248(ra) # 5bbc <printf>
    exit(1);
    16e4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f2:	01250513          	addi	a0,a0,18 # 6700 <statistics+0x9a6>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	04850513          	addi	a0,a0,72 # 6760 <statistics+0xa06>
    1720:	00004097          	auipc	ra,0x4
    1724:	49c080e7          	jalr	1180(ra) # 5bbc <printf>
    exit(1);
    1728:	4505                	li	a0,1
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1788:	6fca8a93          	addi	s5,s5,1788 # be80 <buf>
      if(cc > sizeof(buf))
    ...
    17a6:	6de70713          	addi	a4,a4,1758 # be80 <buf>
    ...
    17dc:	fa050513          	addi	a0,a0,-96 # 6778 <statistics+0xa1e>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	3dc080e7          	jalr	988(ra) # 5bbc <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1802:	682b0b13          	addi	s6,s6,1666 # be80 <buf>
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	f3250513          	addi	a0,a0,-206 # 6790 <statistics+0xa36>
    1866:	00004097          	auipc	ra,0x4
    186a:	356080e7          	jalr	854(ra) # 5bbc <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	f2e50513          	addi	a0,a0,-210 # 67a8 <statistics+0xa4e>
    1882:	00004097          	auipc	ra,0x4
    1886:	33a080e7          	jalr	826(ra) # 5bbc <printf>
}
    ...
    18b0:	f1450513          	addi	a0,a0,-236 # 67c0 <statistics+0xa66>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	308080e7          	jalr	776(ra) # 5bbc <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	ef450513          	addi	a0,a0,-268 # 67e0 <statistics+0xa86>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	2c8080e7          	jalr	712(ra) # 5bbc <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	d1250513          	addi	a0,a0,-750 # 6670 <statistics+0x916>
    1966:	00004097          	auipc	ra,0x4
    196a:	256080e7          	jalr	598(ra) # 5bbc <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	e7e50513          	addi	a0,a0,-386 # 67f8 <statistics+0xa9e>
    1982:	00004097          	auipc	ra,0x4
    1986:	23a080e7          	jalr	570(ra) # 5bbc <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	e7a50513          	addi	a0,a0,-390 # 6810 <statistics+0xab6>
    199e:	00004097          	auipc	ra,0x4
    19a2:	21e080e7          	jalr	542(ra) # 5bbc <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	c6250513          	addi	a0,a0,-926 # 6670 <statistics+0x916>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	1a6080e7          	jalr	422(ra) # 5bbc <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	c3e50513          	addi	a0,a0,-962 # 6670 <statistics+0x916>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	182080e7          	jalr	386(ra) # 5bbc <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	d8450513          	addi	a0,a0,-636 # 6830 <statistics+0xad6>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	108080e7          	jalr	264(ra) # 5bbc <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d84080e7          	jalr	-636(ra) # 5842 <exit>
{
    ...
    1b08:	d3c50513          	addi	a0,a0,-708 # 6840 <statistics+0xae6>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	0b0080e7          	jalr	176(ra) # 5bbc <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	f3e50513          	addi	a0,a0,-194 # 6a90 <statistics+0xd36>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	062080e7          	jalr	98(ra) # 5bbc <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	ea050513          	addi	a0,a0,-352 # 6a90 <statistics+0xd36>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	fc4080e7          	jalr	-60(ra) # 5bbc <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	aec50513          	addi	a0,a0,-1300 # 6708 <statistics+0x9ae>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	f98080e7          	jalr	-104(ra) # 5bbc <printf>
          exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c92:	bd250513          	addi	a0,a0,-1070 # 6860 <statistics+0xb06>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	f26080e7          	jalr	-218(ra) # 5bbc <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	bb650513          	addi	a0,a0,-1098 # 6878 <statistics+0xb1e>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	ef2080e7          	jalr	-270(ra) # 5bbc <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	b7850513          	addi	a0,a0,-1160 # 68a0 <statistics+0xb46>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	e8c080e7          	jalr	-372(ra) # 5bbc <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	0c050513          	addi	a0,a0,192 # 5e88 <statistics+0x12e>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1df6:	e6d9899b          	addiw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c55fdd>
    ...
    1e08:	084a8a93          	addi	s5,s5,132 # 5e88 <statistics+0x12e>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	abcb8b93          	addi	s7,s7,-1348 # 68c8 <statistics+0xb6e>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00005517          	auipc	a0,0x5
    1e1c:	85850513          	addi	a0,a0,-1960 # 6670 <statistics+0x916>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	d9c080e7          	jalr	-612(ra) # 5bbc <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	b8a50513          	addi	a0,a0,-1142 # 6a90 <statistics+0xd36>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	cae080e7          	jalr	-850(ra) # 5bbc <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1f46:	f3eb0b13          	addi	s6,s6,-194 # be80 <buf>
    ...
    1fba:	91a50513          	addi	a0,a0,-1766 # 68d0 <statistics+0xb76>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	bfe080e7          	jalr	-1026(ra) # 5bbc <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	f1250513          	addi	a0,a0,-238 # 5ee8 <statistics+0x18e>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	bde080e7          	jalr	-1058(ra) # 5bbc <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	8dc50513          	addi	a0,a0,-1828 # 6900 <statistics+0xba6>
    202c:	00004097          	auipc	ra,0x4
    2030:	b90080e7          	jalr	-1136(ra) # 5bbc <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	86250513          	addi	a0,a0,-1950 # 68e8 <statistics+0xb8e>
    208e:	00004097          	auipc	ra,0x4
    2092:	b2e080e7          	jalr	-1234(ra) # 5bbc <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	88650513          	addi	a0,a0,-1914 # 6928 <statistics+0xbce>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	b12080e7          	jalr	-1262(ra) # 5bbc <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	88250513          	addi	a0,a0,-1918 # 6940 <statistics+0xbe6>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	af6080e7          	jalr	-1290(ra) # 5bbc <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f4:	35098993          	addi	s3,s3,848 # c350 <buf+0x4d0>
    20f8:	1003d937          	lui	s2,0x1003d
    20fc:	090e                	slli	s2,s2,0x3
    20fe:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e5f0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	53250513          	addi	a0,a0,1330 # 6670 <statistics+0x916>
    2146:	00004097          	auipc	ra,0x4
    214a:	a76080e7          	jalr	-1418(ra) # 5bbc <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	7f850513          	addi	a0,a0,2040 # 6958 <statistics+0xbfe>
    2168:	00004097          	auipc	ra,0x4
    216c:	a54080e7          	jalr	-1452(ra) # 5bbc <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	48e50513          	addi	a0,a0,1166 # 6670 <statistics+0x916>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	9d2080e7          	jalr	-1582(ra) # 5bbc <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	76a50513          	addi	a0,a0,1898 # 6978 <statistics+0xc1e>
    2216:	00004097          	auipc	ra,0x4
    221a:	9a6080e7          	jalr	-1626(ra) # 5bbc <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	75250513          	addi	a0,a0,1874 # 6990 <statistics+0xc36>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	72050513          	addi	a0,a0,1824 # 6990 <statistics+0xc36>
  ...
  close(fd);
    ...
    229a:	3d278793          	addi	a5,a5,978 # 8668 <args.1>
    229e:	00006697          	auipc	a3,0x6
    22a2:	4c268693          	addi	a3,a3,1218 # 8760 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22a6:	00004717          	auipc	a4,0x4
    22aa:	6fa70713          	addi	a4,a4,1786 # 69a0 <statistics+0xc46>
    ...
    22fe:	78650513          	addi	a0,a0,1926 # 6a80 <statistics+0xd26>
    2302:	00004097          	auipc	ra,0x4
    2306:	8ba080e7          	jalr	-1862(ra) # 5bbc <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	78250513          	addi	a0,a0,1922 # 6aa0 <statistics+0xd46>
    2326:	00004097          	auipc	ra,0x4
    232a:	896080e7          	jalr	-1898(ra) # 5bbc <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2376:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0170>
    237a:	85a6                	mv	a1,s1
    237c:	00004517          	auipc	a0,0x4
    2380:	74450513          	addi	a0,a0,1860 # 6ac0 <statistics+0xd66>
    2384:	00004097          	auipc	ra,0x4
    2388:	838080e7          	jalr	-1992(ra) # 5bbc <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	2d850513          	addi	a0,a0,728 # 6670 <statistics+0x916>
    23a0:	00004097          	auipc	ra,0x4
    23a4:	81c080e7          	jalr	-2020(ra) # 5bbc <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	33678793          	addi	a5,a5,822 # 7768 <statistics+0x1a0e>
  ...
  if(ret != -1){
    ...
    2478:	67450513          	addi	a0,a0,1652 # 6ae8 <statistics+0xd8e>
    247c:	00003097          	auipc	ra,0x3
    2480:	740080e7          	jalr	1856(ra) # 5bbc <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	0fe50513          	addi	a0,a0,254 # 6590 <statistics+0x836>
    249a:	00003097          	auipc	ra,0x3
    249e:	722080e7          	jalr	1826(ra) # 5bbc <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	10050513          	addi	a0,a0,256 # 65b0 <statistics+0x856>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	704080e7          	jalr	1796(ra) # 5bbc <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	10050513          	addi	a0,a0,256 # 65d0 <statistics+0x876>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	6e4080e7          	jalr	1764(ra) # 5bbc <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	10a50513          	addi	a0,a0,266 # 65f8 <statistics+0x89e>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	6c6080e7          	jalr	1734(ra) # 5bbc <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	5ee50513          	addi	a0,a0,1518 # 6b28 <statistics+0xdce>
  ...
  if(n >= 0){
    ...
    256e:	5de50513          	addi	a0,a0,1502 # 6b48 <statistics+0xdee>
    2572:	00003097          	auipc	ra,0x3
    2576:	64a080e7          	jalr	1610(ra) # 5bbc <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	56c50513          	addi	a0,a0,1388 # 6af0 <statistics+0xd96>
    258c:	00003097          	auipc	ra,0x3
    2590:	630080e7          	jalr	1584(ra) # 5bbc <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	56a50513          	addi	a0,a0,1386 # 6b08 <statistics+0xdae>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	616080e7          	jalr	1558(ra) # 5bbc <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	57850513          	addi	a0,a0,1400 # 6b30 <statistics+0xdd6>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	5fc080e7          	jalr	1532(ra) # 5bbc <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e0:	54c50513          	addi	a0,a0,1356 # 6b28 <statistics+0xdce>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	2ae080e7          	jalr	686(ra) # 5892 <unlink>
  fd = open("README", O_RDONLY);
    25ec:	4581                	li	a1,0
    25ee:	00004517          	auipc	a0,0x4
    25f2:	9d250513          	addi	a0,a0,-1582 # 5fc0 <statistics+0x266>
  ...
  if(n >= 0){
    ...
    261c:	56050513          	addi	a0,a0,1376 # 6b78 <statistics+0xe1e>
    2620:	00003097          	auipc	ra,0x3
    2624:	59c080e7          	jalr	1436(ra) # 5bbc <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	4fe50513          	addi	a0,a0,1278 # 6b30 <statistics+0xdd6>
    263a:	00003097          	auipc	ra,0x3
    263e:	582080e7          	jalr	1410(ra) # 5bbc <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    269c:	6705                	lui	a4,0x1
      *b = 99;
    269e:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1170>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26b6:	4ee50513          	addi	a0,a0,1262 # 6ba0 <statistics+0xe46>
    26ba:	00003097          	auipc	ra,0x3
    26be:	502080e7          	jalr	1282(ra) # 5bbc <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	4bc50513          	addi	a0,a0,1212 # 6bc0 <statistics+0xe66>
    270c:	00003097          	auipc	ra,0x3
    2710:	4b0080e7          	jalr	1200(ra) # 5bbc <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	4b850513          	addi	a0,a0,1208 # 6c20 <statistics+0xec6>
    2770:	00003097          	auipc	ra,0x3
    2774:	44c080e7          	jalr	1100(ra) # 5bbc <printf>
    exit(1);
    2778:	4505                	li	a0,1
    ...
    278e:	45650513          	addi	a0,a0,1110 # 6be0 <statistics+0xe86>
    2792:	00003097          	auipc	ra,0x3
    2796:	42a080e7          	jalr	1066(ra) # 5bbc <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	45a50513          	addi	a0,a0,1114 # 6c00 <statistics+0xea6>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	40e080e7          	jalr	1038(ra) # 5bbc <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2848:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f116f>
  a = sbrk(0);
    284c:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28ac:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f116f>
  ...
  if(c != a){
    ...
    28f4:	35050513          	addi	a0,a0,848 # 6c40 <statistics+0xee6>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	2c4080e7          	jalr	708(ra) # 5bbc <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	37c50513          	addi	a0,a0,892 # 6c88 <statistics+0xf2e>
    2914:	00003097          	auipc	ra,0x3
    2918:	2a8080e7          	jalr	680(ra) # 5bbc <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	37c50513          	addi	a0,a0,892 # 6ca8 <statistics+0xf4e>
    2934:	00003097          	auipc	ra,0x3
    2938:	288080e7          	jalr	648(ra) # 5bbc <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	39c50513          	addi	a0,a0,924 # 6ce8 <statistics+0xf8e>
    ...
    296c:	3b050513          	addi	a0,a0,944 # 6d18 <statistics+0xfbe>
    ...
    298c:	3c850513          	addi	a0,a0,968 # 6d50 <statistics+0xff6>
    2990:	00003097          	auipc	ra,0x3
    2994:	22c080e7          	jalr	556(ra) # 5bbc <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	3b650513          	addi	a0,a0,950 # 6d78 <statistics+0x101e>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	eb8080e7          	jalr	-328(ra) # 5882 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	3a450513          	addi	a0,a0,932 # 6d78 <statistics+0x101e>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	35850513          	addi	a0,a0,856 # 6d80 <statistics+0x1026>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	18c080e7          	jalr	396(ra) # 5bbc <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	35450513          	addi	a0,a0,852 # 6d98 <statistics+0x103e>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	170080e7          	jalr	368(ra) # 5bbc <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	d1850513          	addi	a0,a0,-744 # 6778 <statistics+0xa1e>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	154080e7          	jalr	340(ra) # 5bbc <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	32650513          	addi	a0,a0,806 # 6db0 <statistics+0x1056>
  ...
  close(fd);
    ...
    2ad6:	bb650513          	addi	a0,a0,-1098 # 6688 <statistics+0x92e>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	0e2080e7          	jalr	226(ra) # 5bbc <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	f7050513          	addi	a0,a0,-144 # 6a90 <statistics+0xd36>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	094080e7          	jalr	148(ra) # 5bbc <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	f1a50513          	addi	a0,a0,-230 # 6a90 <statistics+0xd36>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	03e080e7          	jalr	62(ra) # 5bbc <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bb2:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x1090>
    ...
    2bda:	eba50513          	addi	a0,a0,-326 # 6a90 <statistics+0xd36>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	fde080e7          	jalr	-34(ra) # 5bbc <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce2:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff1174>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	d4650513          	addi	a0,a0,-698 # 6a90 <statistics+0xd36>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	e6a080e7          	jalr	-406(ra) # 5bbc <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	07a50513          	addi	a0,a0,122 # 5e18 <statistics+0xbe>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	0de78793          	addi	a5,a5,222 # 5e88 <statistics+0x12e>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	1ac50513          	addi	a0,a0,428 # 6f88 <statistics+0x122e>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	ff250513          	addi	a0,a0,-14 # 6de0 <statistics+0x1086>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	03450513          	addi	a0,a0,52 # 6e38 <statistics+0x10de>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	08e50513          	addi	a0,a0,142 # 6eb0 <statistics+0x1156>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	0e250513          	addi	a0,a0,226 # 6f20 <statistics+0x11c6>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	12850513          	addi	a0,a0,296 # 6f78 <statistics+0x121e>
  ...
  unlink("12345678901234");
    ...
    2ed2:	eea50513          	addi	a0,a0,-278 # 6db8 <statistics+0x105e>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	ce6080e7          	jalr	-794(ra) # 5bbc <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	f1650513          	addi	a0,a0,-234 # 6e00 <statistics+0x10a6>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	cca080e7          	jalr	-822(ra) # 5bbc <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	f6250513          	addi	a0,a0,-158 # 6e68 <statistics+0x110e>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	cae080e7          	jalr	-850(ra) # 5bbc <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	fbe50513          	addi	a0,a0,-66 # 6ee0 <statistics+0x1186>
    2f2a:	00003097          	auipc	ra,0x3
    2f2e:	c92080e7          	jalr	-878(ra) # 5bbc <printf>
    exit(1);
    2f32:	4505                	li	a0,1
    ...
    2f42:	00250513          	addi	a0,a0,2 # 6f40 <statistics+0x11e6>
    2f46:	00003097          	auipc	ra,0x3
    2f4a:	c76080e7          	jalr	-906(ra) # 5bbc <printf>
    exit(1);
    2f4e:	4505                	li	a0,1
    ...
    2f5e:	03e50513          	addi	a0,a0,62 # 6f98 <statistics+0x123e>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	c5a080e7          	jalr	-934(ra) # 5bbc <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	05050513          	addi	a0,a0,80 # 6fd0 <statistics+0x1276>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	03c50513          	addi	a0,a0,60 # 6fd0 <statistics+0x1276>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	06850513          	addi	a0,a0,104 # 7010 <statistics+0x12b6>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	08450513          	addi	a0,a0,132 # 7040 <statistics+0x12e6>
    ...
    2fe0:	ffc50513          	addi	a0,a0,-4 # 6fd8 <statistics+0x127e>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	bd8080e7          	jalr	-1064(ra) # 5bbc <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	ff850513          	addi	a0,a0,-8 # 6ff0 <statistics+0x1296>
    3000:	00003097          	auipc	ra,0x3
    3004:	bbc080e7          	jalr	-1092(ra) # 5bbc <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	00c50513          	addi	a0,a0,12 # 7020 <statistics+0x12c6>
    301c:	00003097          	auipc	ra,0x3
    3020:	ba0080e7          	jalr	-1120(ra) # 5bbc <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	01850513          	addi	a0,a0,24 # 7048 <statistics+0x12ee>
    3038:	00003097          	auipc	ra,0x3
    303c:	b84080e7          	jalr	-1148(ra) # 5bbc <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	f6c50513          	addi	a0,a0,-148 # 6fd0 <statistics+0x1276>
    ...
    307c:	f5850513          	addi	a0,a0,-168 # 6fd0 <statistics+0x1276>
    ...
    3090:	f8450513          	addi	a0,a0,-124 # 7010 <statistics+0x12b6>
    ...
    30b0:	5c450513          	addi	a0,a0,1476 # 6670 <statistics+0x916>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	b08080e7          	jalr	-1272(ra) # 5bbc <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	f1050513          	addi	a0,a0,-240 # 6fd8 <statistics+0x127e>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	aec080e7          	jalr	-1300(ra) # 5bbc <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	f7c50513          	addi	a0,a0,-132 # 7060 <statistics+0x1306>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	ad0080e7          	jalr	-1328(ra) # 5bbc <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	f2050513          	addi	a0,a0,-224 # 7020 <statistics+0x12c6>
    3108:	00003097          	auipc	ra,0x3
    310c:	ab4080e7          	jalr	-1356(ra) # 5bbc <printf>
      exit(1);
    3110:	4505                	li	a0,1
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	f3a50513          	addi	a0,a0,-198 # 7078 <statistics+0x131e>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	f2650513          	addi	a0,a0,-218 # 7078 <statistics+0x131e>
  ...
  if(chdir("..") < 0){
    ...
    316a:	f3250513          	addi	a0,a0,-206 # 7098 <statistics+0x133e>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	efe50513          	addi	a0,a0,-258 # 7078 <statistics+0x131e>
    ...
    319e:	e3e50513          	addi	a0,a0,-450 # 6fd8 <statistics+0x127e>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	a1a080e7          	jalr	-1510(ra) # 5bbc <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	eca50513          	addi	a0,a0,-310 # 7080 <statistics+0x1326>
    31be:	00003097          	auipc	ra,0x3
    31c2:	9fe080e7          	jalr	-1538(ra) # 5bbc <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	ece50513          	addi	a0,a0,-306 # 70a0 <statistics+0x1346>
    31da:	00003097          	auipc	ra,0x3
    31de:	9e2080e7          	jalr	-1566(ra) # 5bbc <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	eca50513          	addi	a0,a0,-310 # 70b8 <statistics+0x135e>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	9c6080e7          	jalr	-1594(ra) # 5bbc <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	fea50513          	addi	a0,a0,-22 # 7200 <statistics+0x14a6>
    321e:	00002097          	auipc	ra,0x2
    3222:	674080e7          	jalr	1652(ra) # 5892 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	eaa50513          	addi	a0,a0,-342 # 70d0 <statistics+0x1376>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	eb250513          	addi	a0,a0,-334 # 70f0 <statistics+0x1396>
  ...
  write(fd, "ff", 2);
    ...
    325a:	faa58593          	addi	a1,a1,-86 # 7200 <statistics+0x14a6>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	e6050513          	addi	a0,a0,-416 # 70d0 <statistics+0x1376>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	ec450513          	addi	a0,a0,-316 # 7148 <statistics+0x13ee>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	ed450513          	addi	a0,a0,-300 # 7170 <statistics+0x1416>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	eec58593          	addi	a1,a1,-276 # 71a0 <statistics+0x1446>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	ed850513          	addi	a0,a0,-296 # 71a8 <statistics+0x144e>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32ec:	b9858593          	addi	a1,a1,-1128 # be80 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3302:	b8274703          	lbu	a4,-1150(a4) # be80 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	ee058593          	addi	a1,a1,-288 # 71f8 <statistics+0x149e>
    3320:	00004517          	auipc	a0,0x4
    3324:	e5050513          	addi	a0,a0,-432 # 7170 <statistics+0x1416>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	e3c50513          	addi	a0,a0,-452 # 7170 <statistics+0x1416>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	e2650513          	addi	a0,a0,-474 # 7170 <statistics+0x1416>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	d7250513          	addi	a0,a0,-654 # 70d0 <statistics+0x1376>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	f1e50513          	addi	a0,a0,-226 # 7290 <statistics+0x1536>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	f3a50513          	addi	a0,a0,-198 # 72c0 <statistics+0x1566>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	f5650513          	addi	a0,a0,-170 # 72f0 <statistics+0x1596>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	e4850513          	addi	a0,a0,-440 # 71f8 <statistics+0x149e>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33cc:	ab858593          	addi	a1,a1,-1352 # be80 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	d8650513          	addi	a0,a0,-634 # 7170 <statistics+0x1416>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	f7e50513          	addi	a0,a0,-130 # 7380 <statistics+0x1626>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	f9650513          	addi	a0,a0,-106 # 73b0 <statistics+0x1656>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	c9e50513          	addi	a0,a0,-866 # 70d0 <statistics+0x1376>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	c8850513          	addi	a0,a0,-888 # 70d0 <statistics+0x1376>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	c7250513          	addi	a0,a0,-910 # 70d0 <statistics+0x1376>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	fce58593          	addi	a1,a1,-50 # 7440 <statistics+0x16e6>
    347a:	00004517          	auipc	a0,0x4
    347e:	f0650513          	addi	a0,a0,-250 # 7380 <statistics+0x1626>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	fb258593          	addi	a1,a1,-78 # 7440 <statistics+0x16e6>
    3496:	00004517          	auipc	a0,0x4
    349a:	f1a50513          	addi	a0,a0,-230 # 73b0 <statistics+0x1656>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	d4e58593          	addi	a1,a1,-690 # 71f8 <statistics+0x149e>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	c3e50513          	addi	a0,a0,-962 # 70f0 <statistics+0x1396>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	eba50513          	addi	a0,a0,-326 # 7380 <statistics+0x1626>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	ed650513          	addi	a0,a0,-298 # 73b0 <statistics+0x1656>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	d0a50513          	addi	a0,a0,-758 # 71f8 <statistics+0x149e>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	eae50513          	addi	a0,a0,-338 # 73b0 <statistics+0x1656>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	e6a50513          	addi	a0,a0,-406 # 7380 <statistics+0x1626>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	bc650513          	addi	a0,a0,-1082 # 70f0 <statistics+0x1396>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	05250513          	addi	a0,a0,82 # 7590 <statistics+0x1836>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	ca650513          	addi	a0,a0,-858 # 71f8 <statistics+0x149e>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	b8a50513          	addi	a0,a0,-1142 # 70f0 <statistics+0x1396>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	b5650513          	addi	a0,a0,-1194 # 70d0 <statistics+0x1376>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	07250513          	addi	a0,a0,114 # 7600 <statistics+0x18a6>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	b2e50513          	addi	a0,a0,-1234 # 70d0 <statistics+0x1376>
    ...
    35c8:	b1450513          	addi	a0,a0,-1260 # 70d8 <statistics+0x137e>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	5f0080e7          	jalr	1520(ra) # 5bbc <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	b1850513          	addi	a0,a0,-1256 # 70f8 <statistics+0x139e>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	5d4080e7          	jalr	1492(ra) # 5bbc <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	b1c50513          	addi	a0,a0,-1252 # 7118 <statistics+0x13be>
    3604:	00002097          	auipc	ra,0x2
    3608:	5b8080e7          	jalr	1464(ra) # 5bbc <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	b3850513          	addi	a0,a0,-1224 # 7150 <statistics+0x13f6>
    3620:	00002097          	auipc	ra,0x2
    3624:	59c080e7          	jalr	1436(ra) # 5bbc <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	b4c50513          	addi	a0,a0,-1204 # 7180 <statistics+0x1426>
    363c:	00002097          	auipc	ra,0x2
    3640:	580080e7          	jalr	1408(ra) # 5bbc <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	b6850513          	addi	a0,a0,-1176 # 71b8 <statistics+0x145e>
    3658:	00002097          	auipc	ra,0x2
    365c:	564080e7          	jalr	1380(ra) # 5bbc <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	b6c50513          	addi	a0,a0,-1172 # 71d8 <statistics+0x147e>
    3674:	00002097          	auipc	ra,0x2
    3678:	548080e7          	jalr	1352(ra) # 5bbc <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	b8050513          	addi	a0,a0,-1152 # 7208 <statistics+0x14ae>
    3690:	00002097          	auipc	ra,0x2
    3694:	52c080e7          	jalr	1324(ra) # 5bbc <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	b8c50513          	addi	a0,a0,-1140 # 7230 <statistics+0x14d6>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	510080e7          	jalr	1296(ra) # 5bbc <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	b9050513          	addi	a0,a0,-1136 # 7250 <statistics+0x14f6>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	4f4080e7          	jalr	1268(ra) # 5bbc <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	b9c50513          	addi	a0,a0,-1124 # 7278 <statistics+0x151e>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	4d8080e7          	jalr	1240(ra) # 5bbc <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	ba850513          	addi	a0,a0,-1112 # 72a0 <statistics+0x1546>
    3700:	00002097          	auipc	ra,0x2
    3704:	4bc080e7          	jalr	1212(ra) # 5bbc <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	bbc50513          	addi	a0,a0,-1092 # 72d0 <statistics+0x1576>
    371c:	00002097          	auipc	ra,0x2
    3720:	4a0080e7          	jalr	1184(ra) # 5bbc <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	bc850513          	addi	a0,a0,-1080 # 72f8 <statistics+0x159e>
    3738:	00002097          	auipc	ra,0x2
    373c:	484080e7          	jalr	1156(ra) # 5bbc <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	bc450513          	addi	a0,a0,-1084 # 7310 <statistics+0x15b6>
    3754:	00002097          	auipc	ra,0x2
    3758:	468080e7          	jalr	1128(ra) # 5bbc <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	bc850513          	addi	a0,a0,-1080 # 7330 <statistics+0x15d6>
    3770:	00002097          	auipc	ra,0x2
    3774:	44c080e7          	jalr	1100(ra) # 5bbc <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	bcc50513          	addi	a0,a0,-1076 # 7350 <statistics+0x15f6>
    378c:	00002097          	auipc	ra,0x2
    3790:	430080e7          	jalr	1072(ra) # 5bbc <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	bf050513          	addi	a0,a0,-1040 # 7390 <statistics+0x1636>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	414080e7          	jalr	1044(ra) # 5bbc <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	c0450513          	addi	a0,a0,-1020 # 73c0 <statistics+0x1666>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	3f8080e7          	jalr	1016(ra) # 5bbc <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	c0850513          	addi	a0,a0,-1016 # 73e0 <statistics+0x1686>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	3dc080e7          	jalr	988(ra) # 5bbc <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	c0c50513          	addi	a0,a0,-1012 # 7400 <statistics+0x16a6>
    37fc:	00002097          	auipc	ra,0x2
    3800:	3c0080e7          	jalr	960(ra) # 5bbc <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	c1050513          	addi	a0,a0,-1008 # 7420 <statistics+0x16c6>
    3818:	00002097          	auipc	ra,0x2
    381c:	3a4080e7          	jalr	932(ra) # 5bbc <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	c2450513          	addi	a0,a0,-988 # 7450 <statistics+0x16f6>
    3834:	00002097          	auipc	ra,0x2
    3838:	388080e7          	jalr	904(ra) # 5bbc <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	c3050513          	addi	a0,a0,-976 # 7478 <statistics+0x171e>
    3850:	00002097          	auipc	ra,0x2
    3854:	36c080e7          	jalr	876(ra) # 5bbc <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	c3c50513          	addi	a0,a0,-964 # 74a0 <statistics+0x1746>
    386c:	00002097          	auipc	ra,0x2
    3870:	350080e7          	jalr	848(ra) # 5bbc <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	c4850513          	addi	a0,a0,-952 # 74c8 <statistics+0x176e>
    3888:	00002097          	auipc	ra,0x2
    388c:	334080e7          	jalr	820(ra) # 5bbc <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	c4c50513          	addi	a0,a0,-948 # 74e8 <statistics+0x178e>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	318080e7          	jalr	792(ra) # 5bbc <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	c5050513          	addi	a0,a0,-944 # 7508 <statistics+0x17ae>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	2fc080e7          	jalr	764(ra) # 5bbc <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	c5c50513          	addi	a0,a0,-932 # 7530 <statistics+0x17d6>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	2e0080e7          	jalr	736(ra) # 5bbc <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	c6050513          	addi	a0,a0,-928 # 7550 <statistics+0x17f6>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	2c4080e7          	jalr	708(ra) # 5bbc <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	c6450513          	addi	a0,a0,-924 # 7570 <statistics+0x1816>
    3914:	00002097          	auipc	ra,0x2
    3918:	2a8080e7          	jalr	680(ra) # 5bbc <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	c7050513          	addi	a0,a0,-912 # 7598 <statistics+0x183e>
    3930:	00002097          	auipc	ra,0x2
    3934:	28c080e7          	jalr	652(ra) # 5bbc <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	8ec50513          	addi	a0,a0,-1812 # 7230 <statistics+0x14d6>
    394c:	00002097          	auipc	ra,0x2
    3950:	270080e7          	jalr	624(ra) # 5bbc <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	c5850513          	addi	a0,a0,-936 # 75b8 <statistics+0x185e>
    3968:	00002097          	auipc	ra,0x2
    396c:	254080e7          	jalr	596(ra) # 5bbc <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	c5c50513          	addi	a0,a0,-932 # 75d8 <statistics+0x187e>
    3984:	00002097          	auipc	ra,0x2
    3988:	238080e7          	jalr	568(ra) # 5bbc <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	c7050513          	addi	a0,a0,-912 # 7608 <statistics+0x18ae>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	21c080e7          	jalr	540(ra) # 5bbc <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	c7450513          	addi	a0,a0,-908 # 7628 <statistics+0x18ce>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	200080e7          	jalr	512(ra) # 5bbc <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	c6650513          	addi	a0,a0,-922 # 7640 <statistics+0x18e6>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	c5450513          	addi	a0,a0,-940 # 7640 <statistics+0x18e6>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	ad250513          	addi	a0,a0,-1326 # 64d0 <statistics+0x776>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	68850513          	addi	a0,a0,1672 # 7098 <statistics+0x133e>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	61e50513          	addi	a0,a0,1566 # 7040 <statistics+0x12e6>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	c7450513          	addi	a0,a0,-908 # 76a8 <statistics+0x194e>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	c8a50513          	addi	a0,a0,-886 # 76d0 <statistics+0x1976>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	be850513          	addi	a0,a0,-1048 # 7640 <statistics+0x18e6>
    ...
    3a7a:	bd250513          	addi	a0,a0,-1070 # 7648 <statistics+0x18ee>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	13e080e7          	jalr	318(ra) # 5bbc <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	bce50513          	addi	a0,a0,-1074 # 7660 <statistics+0x1906>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	122080e7          	jalr	290(ra) # 5bbc <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	bca50513          	addi	a0,a0,-1078 # 7678 <statistics+0x191e>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	106080e7          	jalr	262(ra) # 5bbc <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	bc650513          	addi	a0,a0,-1082 # 7690 <statistics+0x1936>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	0ea080e7          	jalr	234(ra) # 5bbc <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	56250513          	addi	a0,a0,1378 # 7048 <statistics+0x12ee>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	0ce080e7          	jalr	206(ra) # 5bbc <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	bae50513          	addi	a0,a0,-1106 # 76b0 <statistics+0x1956>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	0b2080e7          	jalr	178(ra) # 5bbc <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	bba50513          	addi	a0,a0,-1094 # 76d8 <statistics+0x197e>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	096080e7          	jalr	150(ra) # 5bbc <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	bbe50513          	addi	a0,a0,-1090 # 76f8 <statistics+0x199e>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	07a080e7          	jalr	122(ra) # 5bbc <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	bb250513          	addi	a0,a0,-1102 # 7718 <statistics+0x19be>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	b9650513          	addi	a0,a0,-1130 # 7718 <statistics+0x19be>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	bca50513          	addi	a0,a0,-1078 # 7760 <statistics+0x1a06>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	bb250513          	addi	a0,a0,-1102 # 7760 <statistics+0x1a06>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	b9e50513          	addi	a0,a0,-1122 # 7760 <statistics+0x1a06>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	b8a50513          	addi	a0,a0,-1142 # 7760 <statistics+0x1a06>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	b7658593          	addi	a1,a1,-1162 # 7760 <statistics+0x1a06>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	3ce50513          	addi	a0,a0,974 # 5fc0 <statistics+0x266>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	b1250513          	addi	a0,a0,-1262 # 7718 <statistics+0x19be>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	8b450513          	addi	a0,a0,-1868 # 64d0 <statistics+0x776>
  ...
  fd = open(".", 0);
    ...
    3c36:	89e50513          	addi	a0,a0,-1890 # 64d0 <statistics+0x776>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	24258593          	addi	a1,a1,578 # 5e88 <statistics+0x12e>
  ...
  close(fd);
    ...
    3c76:	aae50513          	addi	a0,a0,-1362 # 7720 <statistics+0x19c6>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	f42080e7          	jalr	-190(ra) # 5bbc <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	ab250513          	addi	a0,a0,-1358 # 7740 <statistics+0x19e6>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	f26080e7          	jalr	-218(ra) # 5bbc <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	ac650513          	addi	a0,a0,-1338 # 7770 <statistics+0x1a16>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	f0a080e7          	jalr	-246(ra) # 5bbc <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	aaa50513          	addi	a0,a0,-1366 # 7770 <statistics+0x1a16>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	eee080e7          	jalr	-274(ra) # 5bbc <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	ab650513          	addi	a0,a0,-1354 # 7798 <statistics+0x1a3e>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	ed2080e7          	jalr	-302(ra) # 5bbc <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	ac250513          	addi	a0,a0,-1342 # 77c0 <statistics+0x1a66>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	eb6080e7          	jalr	-330(ra) # 5bbc <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	ace50513          	addi	a0,a0,-1330 # 77e8 <statistics+0x1a8e>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	e9a080e7          	jalr	-358(ra) # 5bbc <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	ada50513          	addi	a0,a0,-1318 # 7810 <statistics+0x1ab6>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	e7e080e7          	jalr	-386(ra) # 5bbc <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	ade50513          	addi	a0,a0,-1314 # 7830 <statistics+0x1ad6>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	e62080e7          	jalr	-414(ra) # 5bbc <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	aea50513          	addi	a0,a0,-1302 # 7858 <statistics+0x1afe>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	e46080e7          	jalr	-442(ra) # 5bbc <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	acea0a13          	addi	s4,s4,-1330 # 7870 <statistics+0x1b16>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	5ce48493          	addi	s1,s1,1486 # 7378 <statistics+0x161e>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	20ea8a93          	addi	s5,s5,526 # 5fc0 <statistics+0x266>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	9ae98993          	addi	s3,s3,-1618 # 7768 <statistics+0x1a0e>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	ab250513          	addi	a0,a0,-1358 # 7878 <statistics+0x1b1e>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	dee080e7          	jalr	-530(ra) # 5bbc <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	aae50513          	addi	a0,a0,-1362 # 7890 <statistics+0x1b36>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	dd2080e7          	jalr	-558(ra) # 5bbc <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	22298993          	addi	s3,s3,546 # 7098 <statistics+0x133e>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	9f290913          	addi	s2,s2,-1550 # 7870 <statistics+0x1b16>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	1a250513          	addi	a0,a0,418 # 7040 <statistics+0x12e6>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	9da50513          	addi	a0,a0,-1574 # 78a8 <statistics+0x1b4e>
  ...
  if(pid == 0){
    ...
    3ef6:	9b650513          	addi	a0,a0,-1610 # 78a8 <statistics+0x1b4e>
    ...
    3f0c:	9c050513          	addi	a0,a0,-1600 # 78c8 <statistics+0x1b6e>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	cac080e7          	jalr	-852(ra) # 5bbc <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	98c50513          	addi	a0,a0,-1652 # 78b0 <statistics+0x1b56>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	c90080e7          	jalr	-880(ra) # 5bbc <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	73050513          	addi	a0,a0,1840 # 6670 <statistics+0x916>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	c74080e7          	jalr	-908(ra) # 5bbc <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	93a50513          	addi	a0,a0,-1734 # 78a8 <statistics+0x1b4e>
    ...
    3f86:	8de50513          	addi	a0,a0,-1826 # 6860 <statistics+0xb06>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	c32080e7          	jalr	-974(ra) # 5bbc <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	93050513          	addi	a0,a0,-1744 # 78f0 <statistics+0x1b96>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	90450513          	addi	a0,a0,-1788 # 78f0 <statistics+0x1b96>
  ...
  sleep(10); // one second
    ...
    4028:	80c50513          	addi	a0,a0,-2036 # 6830 <statistics+0xad6>
    ...
    4042:	8b248493          	addi	s1,s1,-1870 # 78f0 <statistics+0x1b96>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
...
0000000000004084 <killstatus>:
{
  ...
  exit(0);
    ...
    40ea:	58a50513          	addi	a0,a0,1418 # 6670 <statistics+0x916>
    40ee:	00002097          	auipc	ra,0x2
    40f2:	ace080e7          	jalr	-1330(ra) # 5bbc <printf>
      exit(1);
    40f6:	4505                	li	a0,1
    ...
    4110:	7f450513          	addi	a0,a0,2036 # 7900 <statistics+0x1ba6>
    4114:	00002097          	auipc	ra,0x2
    4118:	aa8080e7          	jalr	-1368(ra) # 5bbc <printf>
       exit(1);
    411c:	4505                	li	a0,1
...
0000000000004126 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4150:	6e450513          	addi	a0,a0,1764 # 6830 <statistics+0xad6>
    4154:	00002097          	auipc	ra,0x2
    4158:	a68080e7          	jalr	-1432(ra) # 5bbc <printf>
    exit(1);
    415c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    417e:	4f650513          	addi	a0,a0,1270 # 6670 <statistics+0x916>
    4182:	00002097          	auipc	ra,0x2
    4186:	a3a080e7          	jalr	-1478(ra) # 5bbc <printf>
    exit(1);
    418a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c2:	cca58593          	addi	a1,a1,-822 # 5e88 <statistics+0x12e>
    ...
    41ec:	48850513          	addi	a0,a0,1160 # 6670 <statistics+0x916>
    41f0:	00002097          	auipc	ra,0x2
    41f4:	9cc080e7          	jalr	-1588(ra) # 5bbc <printf>
     exit(1);
    41f8:	4505                	li	a0,1
    ...
    4208:	71c50513          	addi	a0,a0,1820 # 7920 <statistics+0x1bc6>
    420c:	00002097          	auipc	ra,0x2
    4210:	9b0080e7          	jalr	-1616(ra) # 5bbc <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4228:	c5c58593          	addi	a1,a1,-932 # be80 <buf>
    ...
    4244:	6f850513          	addi	a0,a0,1784 # 7938 <statistics+0x1bde>
    4248:	00002097          	auipc	ra,0x2
    424c:	974080e7          	jalr	-1676(ra) # 5bbc <printf>
}
  ...
  printf("kill... ");
    ...
    4270:	6e450513          	addi	a0,a0,1764 # 7950 <statistics+0x1bf6>
    4274:	00002097          	auipc	ra,0x2
    4278:	948080e7          	jalr	-1720(ra) # 5bbc <printf>
  kill(pid1);
    427c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    429e:	6c650513          	addi	a0,a0,1734 # 7960 <statistics+0x1c06>
    42a2:	00002097          	auipc	ra,0x2
    42a6:	91a080e7          	jalr	-1766(ra) # 5bbc <printf>
  wait(0);
    42aa:	4501                	li	a0,0
...
00000000000042ca <reparent>:
{
  ...
  exit(0);
    ...
    431e:	35650513          	addi	a0,a0,854 # 6670 <statistics+0x916>
    4322:	00002097          	auipc	ra,0x2
    4326:	89a080e7          	jalr	-1894(ra) # 5bbc <printf>
      exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	4c250513          	addi	a0,a0,1218 # 67f8 <statistics+0xa9e>
    433e:	00002097          	auipc	ra,0x2
    4342:	87e080e7          	jalr	-1922(ra) # 5bbc <printf>
        exit(1);
    4346:	4505                	li	a0,1
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b0:	3cc50513          	addi	a0,a0,972 # 6778 <statistics+0xa1e>
    43b4:	00002097          	auipc	ra,0x2
    43b8:	808080e7          	jalr	-2040(ra) # 5bbc <printf>
    exit(1);
    43bc:	4505                	li	a0,1
    ...
    43e4:	aa858593          	addi	a1,a1,-1368 # 5e88 <statistics+0x12e>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44a8:	4cc50513          	addi	a0,a0,1228 # 7970 <statistics+0x1c16>
    44ac:	00001097          	auipc	ra,0x1
    44b0:	710080e7          	jalr	1808(ra) # 5bbc <printf>
    exit(1);
    44b4:	4505                	li	a0,1
    ...
    44c4:	1b050513          	addi	a0,a0,432 # 6670 <statistics+0x916>
    44c8:	00001097          	auipc	ra,0x1
    44cc:	6f4080e7          	jalr	1780(ra) # 5bbc <printf>
    exit(1);
    44d0:	4505                	li	a0,1
    ...
    44fa:	6705                	lui	a4,0x1
      n += *(a+i);
    44fc:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1170>
    ...
    4510:	48450513          	addi	a0,a0,1156 # 7990 <statistics+0x1c36>
    4514:	00001097          	auipc	ra,0x1
    4518:	6a8080e7          	jalr	1704(ra) # 5bbc <printf>
    exit(1);
    451c:	4505                	li	a0,1
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    457a:	6fe080e7          	jalr	1790(ra) # 5c74 <malloc>
    ...
    45b4:	41050513          	addi	a0,a0,1040 # 79c0 <statistics+0x1c66>
    45b8:	00001097          	auipc	ra,0x1
    45bc:	604080e7          	jalr	1540(ra) # 5bbc <printf>
      exit(1);
    45c0:	4505                	li	a0,1
...
00000000000045d4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    466a:	38a50513          	addi	a0,a0,906 # 79f0 <statistics+0x1c96>
    466e:	00001097          	auipc	ra,0x1
    4672:	54e080e7          	jalr	1358(ra) # 5bbc <printf>
    exit(1);
    4676:	4505                	li	a0,1
    ...
    4686:	39650513          	addi	a0,a0,918 # 7a18 <statistics+0x1cbe>
    468a:	00001097          	auipc	ra,0x1
    468e:	532080e7          	jalr	1330(ra) # 5bbc <printf>
      exit(1);
    4692:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46ca:	31a50513          	addi	a0,a0,794 # 79e0 <statistics+0x1c86>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    470a:	33250513          	addi	a0,a0,818 # 7a38 <statistics+0x1cde>
    470e:	00001097          	auipc	ra,0x1
    4712:	4ae080e7          	jalr	1198(ra) # 5bbc <printf>
    exit(1);
    4716:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4746:	29e50513          	addi	a0,a0,670 # 79e0 <statistics+0x1c86>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    476c:	2f850513          	addi	a0,a0,760 # 7a60 <statistics+0x1d06>
    4770:	00001097          	auipc	ra,0x1
    4774:	44c080e7          	jalr	1100(ra) # 5bbc <printf>
    exit(1);
    4778:	4505                	li	a0,1
...
000000000000478c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b2:	2ca78793          	addi	a5,a5,714 # 7a78 <statistics+0x1d1e>
    47b6:	f6f43823          	sd	a5,-144(s0)
    47ba:	00003797          	auipc	a5,0x3
    47be:	2c678793          	addi	a5,a5,710 # 7a80 <statistics+0x1d26>
    47c2:	f6f43c23          	sd	a5,-136(s0)
    47c6:	00003797          	auipc	a5,0x3
    47ca:	2c278793          	addi	a5,a5,706 # 7a88 <statistics+0x1d2e>
    47ce:	f8f43023          	sd	a5,-128(s0)
    47d2:	00003797          	auipc	a5,0x3
    47d6:	2be78793          	addi	a5,a5,702 # 7a90 <statistics+0x1d36>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    482e:	656a0a13          	addi	s4,s4,1622 # be80 <buf>
    4832:	00007a97          	auipc	s5,0x7
    4836:	64fa8a93          	addi	s5,s5,1615 # be81 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    484e:	24650513          	addi	a0,a0,582 # 6a90 <statistics+0xd36>
    4852:	00001097          	auipc	ra,0x1
    4856:	36a080e7          	jalr	874(ra) # 5bbc <printf>
      exit(1);
    485a:	4505                	li	a0,1
    ...
    48ca:	1d250513          	addi	a0,a0,466 # 7a98 <statistics+0x1d3e>
    48ce:	00001097          	auipc	ra,0x1
    48d2:	2ee080e7          	jalr	750(ra) # 5bbc <printf>
        exit(1);
    48d6:	4505                	li	a0,1
    ...
    48e4:	1c850513          	addi	a0,a0,456 # 7aa8 <statistics+0x1d4e>
    48e8:	00001097          	auipc	ra,0x1
    48ec:	2d4080e7          	jalr	724(ra) # 5bbc <printf>
          exit(1);
    48f0:	4505                	li	a0,1
    ...
    490c:	1b850513          	addi	a0,a0,440 # 7ac0 <statistics+0x1d66>
    4910:	00001097          	auipc	ra,0x1
    4914:	2ac080e7          	jalr	684(ra) # 5bbc <printf>
          exit(1);
    4918:	4505                	li	a0,1
    ...
    493c:	54878793          	addi	a5,a5,1352 # be80 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    499a:	13a50513          	addi	a0,a0,314 # 7ad0 <statistics+0x1d76>
    499e:	00001097          	auipc	ra,0x1
    49a2:	21e080e7          	jalr	542(ra) # 5bbc <printf>
      exit(1);
    49a6:	4505                	li	a0,1
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49fc:	0f0b8b93          	addi	s7,s7,240 # 7ae8 <statistics+0x1d8e>
  for(i = 0; i < N; i++){
    ...
    4a3e:	0b650513          	addi	a0,a0,182 # 7af0 <statistics+0x1d96>
    4a42:	00001097          	auipc	ra,0x1
    4a46:	17a080e7          	jalr	378(ra) # 5bbc <printf>
        exit(1);
    4a4a:	4505                	li	a0,1
    ...
    4a5c:	09050513          	addi	a0,a0,144 # 7ae8 <statistics+0x1d8e>
  ...
  fd = open(".", 0);
    ...
    4a94:	a4050513          	addi	a0,a0,-1472 # 64d0 <statistics+0x776>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b0c:	00850513          	addi	a0,a0,8 # 7b10 <statistics+0x1db6>
    4b10:	00001097          	auipc	ra,0x1
    4b14:	0ac080e7          	jalr	172(ra) # 5bbc <printf>
        exit(1);
    4b18:	4505                	li	a0,1
    ...
    4b2c:	00850513          	addi	a0,a0,8 # 7b30 <statistics+0x1dd6>
    4b30:	00001097          	auipc	ra,0x1
    4b34:	08c080e7          	jalr	140(ra) # 5bbc <printf>
        exit(1);
    4b38:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b64:	ff850513          	addi	a0,a0,-8 # 7b58 <statistics+0x1dfe>
    4b68:	00001097          	auipc	ra,0x1
    4b6c:	054080e7          	jalr	84(ra) # 5bbc <printf>
    exit(1);
    4b70:	4505                	li	a0,1
    ...
    4b80:	af450513          	addi	a0,a0,-1292 # 6670 <statistics+0x916>
    4b84:	00001097          	auipc	ra,0x1
    4b88:	038080e7          	jalr	56(ra) # 5bbc <printf>
      exit(1);
    4b8c:	4505                	li	a0,1
...
0000000000004d2a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6a:	11a90913          	addi	s2,s2,282 # be80 <buf>
  for(i = 0; i < N; i++){
    4d6e:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db2:	de250513          	addi	a0,a0,-542 # 7b90 <statistics+0x1e36>
  ...
  for(i = 0; ; i++){
    ...
    4dc8:	0bc90913          	addi	s2,s2,188 # be80 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e16:	d8e50513          	addi	a0,a0,-626 # 7ba0 <statistics+0x1e46>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	da2080e7          	jalr	-606(ra) # 5bbc <printf>
    exit(1);
    4e22:	4505                	li	a0,1
    ...
    4e32:	d9250513          	addi	a0,a0,-622 # 7bc0 <statistics+0x1e66>
    4e36:	00001097          	auipc	ra,0x1
    4e3a:	d86080e7          	jalr	-634(ra) # 5bbc <printf>
      exit(1);
    4e3e:	4505                	li	a0,1
    ...
    4e4e:	d9650513          	addi	a0,a0,-618 # 7be0 <statistics+0x1e86>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	d6a080e7          	jalr	-662(ra) # 5bbc <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    ...
    4e6a:	d9a50513          	addi	a0,a0,-614 # 7c00 <statistics+0x1ea6>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	d4e080e7          	jalr	-690(ra) # 5bbc <printf>
      exit(1);
    4e76:	4505                	li	a0,1
    ...
    4e86:	d9e50513          	addi	a0,a0,-610 # 7c20 <statistics+0x1ec6>
    4e8a:	00001097          	auipc	ra,0x1
    4e8e:	d32080e7          	jalr	-718(ra) # 5bbc <printf>
      exit(1);
    4e92:	4505                	li	a0,1
    ...
    4ea2:	d9a50513          	addi	a0,a0,-614 # 7c38 <statistics+0x1ede>
    4ea6:	00001097          	auipc	ra,0x1
    4eaa:	d16080e7          	jalr	-746(ra) # 5bbc <printf>
      exit(1);
    4eae:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed0:	cc450513          	addi	a0,a0,-828 # 7b90 <statistics+0x1e36>
    ...
    4ef4:	d6850513          	addi	a0,a0,-664 # 7c58 <statistics+0x1efe>
    4ef8:	00001097          	auipc	ra,0x1
    4efc:	cc4080e7          	jalr	-828(ra) # 5bbc <printf>
    exit(1);
    4f00:	4505                	li	a0,1
...
0000000000004f0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f2c:	d5050513          	addi	a0,a0,-688 # 7c78 <statistics+0x1f1e>
    4f30:	00001097          	auipc	ra,0x1
    4f34:	c8c080e7          	jalr	-884(ra) # 5bbc <printf>
  for(nfiles = 0; ; nfiles++){
    4f38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f4c:	d40c8c93          	addi	s9,s9,-704 # 7c88 <statistics+0x1f2e>
    int total = 0;
    4f50:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f52:	00007a17          	auipc	s4,0x7
    4f56:	f2ea0a13          	addi	s4,s4,-210 # be80 <buf>
    name[0] = 'f';
    ...
    4fa4:	c1c080e7          	jalr	-996(ra) # 5bbc <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fc6:	cd650513          	addi	a0,a0,-810 # 7c98 <statistics+0x1f3e>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	bf2080e7          	jalr	-1038(ra) # 5bbc <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    503c:	c8050513          	addi	a0,a0,-896 # 7cb8 <statistics+0x1f5e>
    5040:	00001097          	auipc	ra,0x1
    5044:	b7c080e7          	jalr	-1156(ra) # 5bbc <printf>
}
    ...
    508c:	c2050513          	addi	a0,a0,-992 # 7ca8 <statistics+0x1f4e>
    5090:	00001097          	auipc	ra,0x1
    5094:	b2c080e7          	jalr	-1236(ra) # 5bbc <printf>
    close(fd);
    5098:	854a                	mv	a0,s2
...
00000000000050aa <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    511e:	bb650513          	addi	a0,a0,-1098 # 7cd0 <statistics+0x1f76>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5136:	d5658593          	addi	a1,a1,-682 # 5e88 <statistics+0x12e>
    ...
    514c:	ba850513          	addi	a0,a0,-1112 # 7cf0 <statistics+0x1f96>
    5150:	00001097          	auipc	ra,0x1
    5154:	a6c080e7          	jalr	-1428(ra) # 5bbc <printf>
    exit(1);
    5158:	4505                	li	a0,1
    ...
    5166:	b7650513          	addi	a0,a0,-1162 # 7cd8 <statistics+0x1f7e>
    516a:	00001097          	auipc	ra,0x1
    516e:	a52080e7          	jalr	-1454(ra) # 5bbc <printf>
      exit(1);
    5172:	4505                	li	a0,1
    ...
    5180:	b5c50513          	addi	a0,a0,-1188 # 7cd8 <statistics+0x1f7e>
    5184:	00001097          	auipc	ra,0x1
    5188:	a38080e7          	jalr	-1480(ra) # 5bbc <printf>
    exit(1);
    518c:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a4:	b3050513          	addi	a0,a0,-1232 # 7cd0 <statistics+0x1f76>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fa:	c9298993          	addi	s3,s3,-878 # 5e88 <statistics+0x12e>
      uint64 a = (uint64) sbrk(4096);
    ...
    522c:	b1850513          	addi	a0,a0,-1256 # 7d40 <statistics+0x1fe6>
    5230:	00001097          	auipc	ra,0x1
    5234:	98c080e7          	jalr	-1652(ra) # 5bbc <printf>
        exit(1);
    5238:	4505                	li	a0,1
    ...
    5246:	abe50513          	addi	a0,a0,-1346 # 7d00 <statistics+0x1fa6>
    524a:	00001097          	auipc	ra,0x1
    524e:	972080e7          	jalr	-1678(ra) # 5bbc <printf>
    exit(1);
    5252:	4505                	li	a0,1
    ...
    5260:	ac450513          	addi	a0,a0,-1340 # 7d20 <statistics+0x1fc6>
    5264:	00001097          	auipc	ra,0x1
    5268:	958080e7          	jalr	-1704(ra) # 5bbc <printf>
    exit(1);
    526c:	4505                	li	a0,1
  ...
  while(1){
    ...
    52ae:	ab650513          	addi	a0,a0,-1354 # 7d60 <statistics+0x2006>
    52b2:	00001097          	auipc	ra,0x1
    52b6:	90a080e7          	jalr	-1782(ra) # 5bbc <printf>
      exit(1);
    52ba:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52fe:	a8650513          	addi	a0,a0,-1402 # 7d80 <statistics+0x2026>
    5302:	00001097          	auipc	ra,0x1
    5306:	8ba080e7          	jalr	-1862(ra) # 5bbc <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    532e:	a7e50513          	addi	a0,a0,-1410 # 7da8 <statistics+0x204e>
    5332:	00001097          	auipc	ra,0x1
    5336:	88a080e7          	jalr	-1910(ra) # 5bbc <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5352:	a4250513          	addi	a0,a0,-1470 # 7d90 <statistics+0x2036>
    5356:	00001097          	auipc	ra,0x1
    535a:	866080e7          	jalr	-1946(ra) # 5bbc <printf>
    exit(1);
    535e:	4505                	li	a0,1
    ...
    537a:	a3a50513          	addi	a0,a0,-1478 # 7db0 <statistics+0x2056>
    537e:	00001097          	auipc	ra,0x1
    5382:	83e080e7          	jalr	-1986(ra) # 5bbc <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c4:	e0878793          	addi	a5,a5,-504 # 81c8 <statistics+0x246e>
    53c8:	bd040713          	addi	a4,s0,-1072
    53cc:	00003317          	auipc	t1,0x3
    53d0:	1ec30313          	addi	t1,t1,492 # 85b8 <statistics+0x285e>
  ...
  printf("usertests starting\n");
    ...
    5404:	a6850513          	addi	a0,a0,-1432 # 7e68 <statistics+0x210e>
    5408:	00000097          	auipc	ra,0x0
    540c:	7b4080e7          	jalr	1972(ra) # 5bbc <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    543c:	9e850513          	addi	a0,a0,-1560 # 7e20 <statistics+0x20c6>
    5440:	00000097          	auipc	ra,0x0
    5444:	77c080e7          	jalr	1916(ra) # 5bbc <printf>
    exit(1);
    5448:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5458:	96458593          	addi	a1,a1,-1692 # 7db8 <statistics+0x205e>
    ...
    546e:	a3658593          	addi	a1,a1,-1482 # 7ea0 <statistics+0x2146>
    ...
    5492:	93250513          	addi	a0,a0,-1742 # 7dc0 <statistics+0x2066>
    5496:	00000097          	auipc	ra,0x0
    549a:	726080e7          	jalr	1830(ra) # 5bbc <printf>
    exit(1);
    549e:	4505                	li	a0,1
    ...
    54bc:	704080e7          	jalr	1796(ra) # 5bbc <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    54fe:	90e50513          	addi	a0,a0,-1778 # 7e08 <statistics+0x20ae>
    5502:	00000097          	auipc	ra,0x0
    5506:	6ba080e7          	jalr	1722(ra) # 5bbc <printf>
    exit(1);
    550a:	4505                	li	a0,1
    ...
    5518:	93c50513          	addi	a0,a0,-1732 # 7e50 <statistics+0x20f6>
    551c:	00000097          	auipc	ra,0x0
    5520:	6a0080e7          	jalr	1696(ra) # 5bbc <printf>
    exit(0);
    5524:	4501                	li	a0,0
    ...
    5534:	68c080e7          	jalr	1676(ra) # 5bbc <printf>
        if(continuous != 2)
    ...
    5576:	c5678793          	addi	a5,a5,-938 # 81c8 <statistics+0x246e>
    557a:	bd040713          	addi	a4,s0,-1072
    557e:	00003317          	auipc	t1,0x3
    5582:	03a30313          	addi	t1,t1,58 # 85b8 <statistics+0x285e>
    ...
    55b6:	8ce50513          	addi	a0,a0,-1842 # 7e80 <statistics+0x2126>
    55ba:	00000097          	auipc	ra,0x0
    55be:	602080e7          	jalr	1538(ra) # 5bbc <printf>
        printf("SOME TESTS FAILED\n");
    55c2:	00003a97          	auipc	s5,0x3
    55c6:	846a8a93          	addi	s5,s5,-1978 # 7e08 <statistics+0x20ae>
        if(continuous != 2)
    55ca:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55cc:	00003b17          	auipc	s6,0x3
    55d0:	81cb0b13          	addi	s6,s6,-2020 # 7de8 <statistics+0x208e>
...
putc(int fd, char c)
{
    58e2:	1101                	addi	sp,sp,-32
    58e4:	ec06                	sd	ra,24(sp)
    58e6:	e822                	sd	s0,16(sp)
    58e8:	1000                	addi	s0,sp,32
    58ea:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    58ee:	4605                	li	a2,1
    58f0:	fef40593          	addi	a1,s0,-17
    58f4:	00000097          	auipc	ra,0x0
    58f8:	f6e080e7          	jalr	-146(ra) # 5862 <write>
}
    58fc:	60e2                	ld	ra,24(sp)
    58fe:	6442                	ld	s0,16(sp)
    5900:	6105                	addi	sp,sp,32
    5902:	8082                	ret

0000000000005904 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    5914:	c299                	beqz	a3,591a <printint+0x16>
    5916:	0805c963          	bltz	a1,59a8 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    591a:	2581                	sext.w	a1,a1
  neg = 0;
    591c:	4881                	li	a7,0
    591e:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5924:	2601                	sext.w	a2,a2
    5926:	00003517          	auipc	a0,0x3
    592a:	cf250513          	addi	a0,a0,-782 # 8618 <digits>
    592e:	883a                	mv	a6,a4
    5930:	2705                	addiw	a4,a4,1
    5932:	02c5f7bb          	remuw	a5,a1,a2
    5936:	1782                	slli	a5,a5,0x20
    5938:	9381                	srli	a5,a5,0x20
    593a:	97aa                	add	a5,a5,a0
    593c:	0007c783          	lbu	a5,0(a5)
    5940:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5944:	0005879b          	sext.w	a5,a1
    5948:	02c5d5bb          	divuw	a1,a1,a2
    594c:	0685                	addi	a3,a3,1
    594e:	fec7f0e3          	bgeu	a5,a2,592e <printint+0x2a>
  if(neg)
    5952:	00088c63          	beqz	a7,596a <printint+0x66>
    buf[i++] = '-';
    5956:	fd070793          	addi	a5,a4,-48
    595a:	00878733          	add	a4,a5,s0
    595e:	02d00793          	li	a5,45
    5962:	fef70823          	sb	a5,-16(a4)
    5966:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    596a:	02e05863          	blez	a4,599a <printint+0x96>
    ...
    5990:	f56080e7          	jalr	-170(ra) # 58e2 <putc>
  while(--i >= 0)
    5994:	197d                	addi	s2,s2,-1
    5996:	ff3918e3          	bne	s2,s3,5986 <printint+0x82>
}
    ...
    59ac:	4885                	li	a7,1
    x = -xx;
    59ae:	bf85                	j	591e <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    59e4:	4c55                	li	s8,21
    59e6:	00003c97          	auipc	s9,0x3
    59ea:	bdac8c93          	addi	s9,s9,-1062 # 85c0 <statistics+0x2866>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    59ee:	02800d93          	li	s11,40
  putc(fd, 'x');
    59f2:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    59f4:	00003b97          	auipc	s7,0x3
    59f8:	c24b8b93          	addi	s7,s7,-988 # 8618 <digits>
    59fc:	a839                	j	5a1a <vprintf+0x6a>
        putc(fd, c);
    59fe:	85ca                	mv	a1,s2
    5a00:	8556                	mv	a0,s5
    5a02:	00000097          	auipc	ra,0x0
    5a06:	ee0080e7          	jalr	-288(ra) # 58e2 <putc>
    5a0a:	a019                	j	5a10 <vprintf+0x60>
    } else if(state == '%'){
    5a0c:	01498d63          	beq	s3,s4,5a26 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5a10:	0485                	addi	s1,s1,1
    5a12:	fff4c903          	lbu	s2,-1(s1)
    5a16:	14090d63          	beqz	s2,5b70 <vprintf+0x1c0>
    if(state == 0){
    5a1a:	fe0999e3          	bnez	s3,5a0c <vprintf+0x5c>
      if(c == '%'){
    5a1e:	ff4910e3          	bne	s2,s4,59fe <vprintf+0x4e>
        state = '%';
    5a22:	89d2                	mv	s3,s4
    5a24:	b7f5                	j	5a10 <vprintf+0x60>
      if(c == 'd'){
    5a26:	11490c63          	beq	s2,s4,5b3e <vprintf+0x18e>
    5a2a:	f9d9079b          	addiw	a5,s2,-99
    5a2e:	0ff7f793          	zext.b	a5,a5
    5a32:	10fc6e63          	bltu	s8,a5,5b4e <vprintf+0x19e>
    5a36:	f9d9079b          	addiw	a5,s2,-99
    5a3a:	0ff7f713          	zext.b	a4,a5
    5a3e:	10ec6863          	bltu	s8,a4,5b4e <vprintf+0x19e>
    5a42:	00271793          	slli	a5,a4,0x2
    5a46:	97e6                	add	a5,a5,s9
    5a48:	439c                	lw	a5,0(a5)
    5a4a:	97e6                	add	a5,a5,s9
    5a4c:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5a4e:	008b0913          	addi	s2,s6,8
    5a52:	4685                	li	a3,1
    5a54:	4629                	li	a2,10
    5a56:	000b2583          	lw	a1,0(s6)
    5a5a:	8556                	mv	a0,s5
    5a5c:	00000097          	auipc	ra,0x0
    5a60:	ea8080e7          	jalr	-344(ra) # 5904 <printint>
    5a64:	8b4a                	mv	s6,s2
      } else {
    ...
    5a7c:	e8c080e7          	jalr	-372(ra) # 5904 <printint>
    5a80:	8b4a                	mv	s6,s2
      state = 0;
    5a82:	4981                	li	s3,0
    ...
    5a98:	e70080e7          	jalr	-400(ra) # 5904 <printint>
    5a9c:	8b4a                	mv	s6,s2
      state = 0;
    5a9e:	4981                	li	s3,0
    5aa0:	bf85                	j	5a10 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5aa2:	008b0793          	addi	a5,s6,8
    5aa6:	f8f43423          	sd	a5,-120(s0)
    5aaa:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5aae:	03000593          	li	a1,48
    5ab2:	8556                	mv	a0,s5
    5ab4:	00000097          	auipc	ra,0x0
    5ab8:	e2e080e7          	jalr	-466(ra) # 58e2 <putc>
  putc(fd, 'x');
    5abc:	07800593          	li	a1,120
    5ac0:	8556                	mv	a0,s5
    5ac2:	00000097          	auipc	ra,0x0
    5ac6:	e20080e7          	jalr	-480(ra) # 58e2 <putc>
    5aca:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5acc:	03c9d793          	srli	a5,s3,0x3c
    5ad0:	97de                	add	a5,a5,s7
    5ad2:	0007c583          	lbu	a1,0(a5)
    5ad6:	8556                	mv	a0,s5
    5ad8:	00000097          	auipc	ra,0x0
    5adc:	e0a080e7          	jalr	-502(ra) # 58e2 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5ae0:	0992                	slli	s3,s3,0x4
    5ae2:	397d                	addiw	s2,s2,-1
    5ae4:	fe0914e3          	bnez	s2,5acc <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5ae8:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5aec:	4981                	li	s3,0
    5aee:	b70d                	j	5a10 <vprintf+0x60>
        s = va_arg(ap, char*);
    5af0:	008b0913          	addi	s2,s6,8
    5af4:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5af8:	02098163          	beqz	s3,5b1a <vprintf+0x16a>
        while(*s != 0){
    5afc:	0009c583          	lbu	a1,0(s3)
    5b00:	c5ad                	beqz	a1,5b6a <vprintf+0x1ba>
          putc(fd, *s);
    5b02:	8556                	mv	a0,s5
    5b04:	00000097          	auipc	ra,0x0
    5b08:	dde080e7          	jalr	-546(ra) # 58e2 <putc>
          s++;
    5b0c:	0985                	addi	s3,s3,1
        while(*s != 0){
    5b0e:	0009c583          	lbu	a1,0(s3)
    5b12:	f9e5                	bnez	a1,5b02 <vprintf+0x152>
        s = va_arg(ap, char*);
    5b14:	8b4a                	mv	s6,s2
      state = 0;
    5b16:	4981                	li	s3,0
    5b18:	bde5                	j	5a10 <vprintf+0x60>
          s = "(null)";
    5b1a:	00003997          	auipc	s3,0x3
    5b1e:	a9e98993          	addi	s3,s3,-1378 # 85b8 <statistics+0x285e>
        while(*s != 0){
    5b22:	85ee                	mv	a1,s11
    5b24:	bff9                	j	5b02 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5b26:	008b0913          	addi	s2,s6,8
    5b2a:	000b4583          	lbu	a1,0(s6)
    5b2e:	8556                	mv	a0,s5
    5b30:	00000097          	auipc	ra,0x0
    5b34:	db2080e7          	jalr	-590(ra) # 58e2 <putc>
    5b38:	8b4a                	mv	s6,s2
      state = 0;
    5b3a:	4981                	li	s3,0
    5b3c:	bdd1                	j	5a10 <vprintf+0x60>
        putc(fd, c);
    5b3e:	85d2                	mv	a1,s4
    5b40:	8556                	mv	a0,s5
    5b42:	00000097          	auipc	ra,0x0
    5b46:	da0080e7          	jalr	-608(ra) # 58e2 <putc>
      state = 0;
    5b4a:	4981                	li	s3,0
    5b4c:	b5d1                	j	5a10 <vprintf+0x60>
        putc(fd, '%');
    5b4e:	85d2                	mv	a1,s4
    5b50:	8556                	mv	a0,s5
    5b52:	00000097          	auipc	ra,0x0
    5b56:	d90080e7          	jalr	-624(ra) # 58e2 <putc>
        putc(fd, c);
    5b5a:	85ca                	mv	a1,s2
    5b5c:	8556                	mv	a0,s5
    5b5e:	00000097          	auipc	ra,0x0
    5b62:	d84080e7          	jalr	-636(ra) # 58e2 <putc>
      state = 0;
    5b66:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5bfc:	00003797          	auipc	a5,0x3
    5c00:	a647b783          	ld	a5,-1436(a5) # 8660 <freep>
    5c04:	a02d                	j	5c2e <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c06:	4618                	lw	a4,8(a2)
    5c08:	9f2d                	addw	a4,a4,a1
    5c0a:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c0e:	6398                	ld	a4,0(a5)
    5c10:	6310                	ld	a2,0(a4)
    5c12:	a83d                	j	5c50 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c14:	ff852703          	lw	a4,-8(a0)
    5c18:	9f31                	addw	a4,a4,a2
    5c1a:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5c1c:	ff053683          	ld	a3,-16(a0)
    5c20:	a091                	j	5c64 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c22:	6398                	ld	a4,0(a5)
    5c24:	00e7e463          	bltu	a5,a4,5c2c <free+0x3a>
    5c28:	00e6ea63          	bltu	a3,a4,5c3c <free+0x4a>
{
    5c2c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c2e:	fed7fae3          	bgeu	a5,a3,5c22 <free+0x30>
    5c32:	6398                	ld	a4,0(a5)
    5c34:	00e6e463          	bltu	a3,a4,5c3c <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c38:	fee7eae3          	bltu	a5,a4,5c2c <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5c3c:	ff852583          	lw	a1,-8(a0)
    5c40:	6390                	ld	a2,0(a5)
    5c42:	02059813          	slli	a6,a1,0x20
    5c46:	01c85713          	srli	a4,a6,0x1c
    5c4a:	9736                	add	a4,a4,a3
    5c4c:	fae60de3          	beq	a2,a4,5c06 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5c50:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c54:	4790                	lw	a2,8(a5)
    5c56:	02061593          	slli	a1,a2,0x20
    5c5a:	01c5d713          	srli	a4,a1,0x1c
    5c5e:	973e                	add	a4,a4,a5
    5c60:	fae68ae3          	beq	a3,a4,5c14 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5c64:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5c66:	00003717          	auipc	a4,0x3
    5c6a:	9ef73d23          	sd	a5,-1542(a4) # 8660 <freep>
}
    5c6e:	6422                	ld	s0,8(sp)
    5c70:	0141                	addi	sp,sp,16
    5c72:	8082                	ret

0000000000005c74 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    5c80:	e852                	sd	s4,16(sp)
    5c82:	e456                	sd	s5,8(sp)
    5c84:	e05a                	sd	s6,0(sp)
    5c86:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5c88:	02051493          	slli	s1,a0,0x20
    5c8c:	9081                	srli	s1,s1,0x20
    5c8e:	04bd                	addi	s1,s1,15
    5c90:	8091                	srli	s1,s1,0x4
    5c92:	0014899b          	addiw	s3,s1,1
    5c96:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5c98:	00003517          	auipc	a0,0x3
    5c9c:	9c853503          	ld	a0,-1592(a0) # 8660 <freep>
    5ca0:	c515                	beqz	a0,5ccc <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5ca2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5ca4:	4798                	lw	a4,8(a5)
    5ca6:	02977f63          	bgeu	a4,s1,5ce4 <malloc+0x70>
    5caa:	8a4e                	mv	s4,s3
    5cac:	0009871b          	sext.w	a4,s3
    5cb0:	6685                	lui	a3,0x1
    5cb2:	00d77363          	bgeu	a4,a3,5cb8 <malloc+0x44>
    5cb6:	6a05                	lui	s4,0x1
    5cb8:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5cbc:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5cc0:	00003917          	auipc	s2,0x3
    5cc4:	9a090913          	addi	s2,s2,-1632 # 8660 <freep>
  if(p == (char*)-1)
    5cc8:	5afd                	li	s5,-1
    5cca:	a895                	j	5d3e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5ccc:	00009797          	auipc	a5,0x9
    5cd0:	1b478793          	addi	a5,a5,436 # ee80 <base>
    5cd4:	00003717          	auipc	a4,0x3
    5cd8:	98f73623          	sd	a5,-1652(a4) # 8660 <freep>
    5cdc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5cde:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5ce2:	b7e1                	j	5caa <malloc+0x36>
      if(p->s.size == nunits)
    5ce4:	02e48c63          	beq	s1,a4,5d1c <malloc+0xa8>
        p->s.size -= nunits;
    5ce8:	4137073b          	subw	a4,a4,s3
    5cec:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5cee:	02071693          	slli	a3,a4,0x20
    5cf2:	01c6d713          	srli	a4,a3,0x1c
    5cf6:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5cf8:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5cfc:	00003717          	auipc	a4,0x3
    5d00:	96a73223          	sd	a0,-1692(a4) # 8660 <freep>
      return (void*)(p + 1);
    5d04:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5d08:	70e2                	ld	ra,56(sp)
    5d0a:	7442                	ld	s0,48(sp)
    5d0c:	74a2                	ld	s1,40(sp)
    5d0e:	7902                	ld	s2,32(sp)
    5d10:	69e2                	ld	s3,24(sp)
    5d12:	6a42                	ld	s4,16(sp)
    5d14:	6aa2                	ld	s5,8(sp)
    5d16:	6b02                	ld	s6,0(sp)
    5d18:	6121                	addi	sp,sp,64
    5d1a:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d1c:	6398                	ld	a4,0(a5)
    5d1e:	e118                	sd	a4,0(a0)
    5d20:	bff1                	j	5cfc <malloc+0x88>
  hp->s.size = nu;
    5d22:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d26:	0541                	addi	a0,a0,16
    5d28:	00000097          	auipc	ra,0x0
    5d2c:	eca080e7          	jalr	-310(ra) # 5bf2 <free>
  return freep;
    5d30:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d34:	d971                	beqz	a0,5d08 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d36:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d38:	4798                	lw	a4,8(a5)
    5d3a:	fa9775e3          	bgeu	a4,s1,5ce4 <malloc+0x70>
    if(p == freep)
    5d3e:	00093703          	ld	a4,0(s2)
    5d42:	853e                	mv	a0,a5
    5d44:	fef719e3          	bne	a4,a5,5d36 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5d48:	8552                	mv	a0,s4
    5d4a:	00000097          	auipc	ra,0x0
    5d4e:	b80080e7          	jalr	-1152(ra) # 58ca <sbrk>
  if(p == (char*)-1)
    5d52:	fd5518e3          	bne	a0,s5,5d22 <malloc+0xae>
        return 0;
    5d56:	4501                	li	a0,0
    5d58:	bf45                	j	5d08 <malloc+0x94>

0000000000005d5a <statistics>:
#include "kernel/fcntl.h"
#include "user/user.h"
...
{
    5d5a:	7179                	addi	sp,sp,-48
    5d5c:	f406                	sd	ra,40(sp)
    5d5e:	f022                	sd	s0,32(sp)
    5d60:	ec26                	sd	s1,24(sp)
    5d62:	e84a                	sd	s2,16(sp)
    5d64:	e44e                	sd	s3,8(sp)
    5d66:	e052                	sd	s4,0(sp)
    5d68:	1800                	addi	s0,sp,48
    5d6a:	8a2a                	mv	s4,a0
    5d6c:	892e                	mv	s2,a1
  int fd, i, n;
  ...
  fd = open("statistics", O_RDONLY);
    5d6e:	4581                	li	a1,0
    5d70:	00003517          	auipc	a0,0x3
    5d74:	8c050513          	addi	a0,a0,-1856 # 8630 <digits+0x18>
    5d78:	00000097          	auipc	ra,0x0
    5d7c:	b0a080e7          	jalr	-1270(ra) # 5882 <open>
  if(fd < 0) {
    5d80:	04054263          	bltz	a0,5dc4 <statistics+0x6a>
    5d84:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
    5d86:	4481                	li	s1,0
    5d88:	03205063          	blez	s2,5da8 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
    5d8c:	4099063b          	subw	a2,s2,s1
    5d90:	009a05b3          	add	a1,s4,s1
    5d94:	854e                	mv	a0,s3
    5d96:	00000097          	auipc	ra,0x0
    5d9a:	ac4080e7          	jalr	-1340(ra) # 585a <read>
    5d9e:	00054563          	bltz	a0,5da8 <statistics+0x4e>
      break;
    }
    i += n;
    5da2:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
    5da4:	ff24c4e3          	blt	s1,s2,5d8c <statistics+0x32>
  }
  close(fd);
    5da8:	854e                	mv	a0,s3
    5daa:	00000097          	auipc	ra,0x0
    5dae:	ac0080e7          	jalr	-1344(ra) # 586a <close>
  return i;
}
    5db2:	8526                	mv	a0,s1
    5db4:	70a2                	ld	ra,40(sp)
    5db6:	7402                	ld	s0,32(sp)
    5db8:	64e2                	ld	s1,24(sp)
    5dba:	6942                	ld	s2,16(sp)
    5dbc:	69a2                	ld	s3,8(sp)
    5dbe:	6a02                	ld	s4,0(sp)
    5dc0:	6145                	addi	sp,sp,48
    5dc2:	8082                	ret
      fprintf(2, "stats: open failed\n");
    5dc4:	00003597          	auipc	a1,0x3
    5dc8:	87c58593          	addi	a1,a1,-1924 # 8640 <digits+0x28>
    5dcc:	4509                	li	a0,2
    5dce:	00000097          	auipc	ra,0x0
    5dd2:	dc0080e7          	jalr	-576(ra) # 5b8e <fprintf>
      exit(1);
    5dd6:	4505                	li	a0,1
    5dd8:	00000097          	auipc	ra,0x0
    5ddc:	a6a080e7          	jalr	-1430(ra) # 5842 <exit>

...
main(int argc, char *argv[])
{
  ...
  4c:	2de080e7          	jalr	734(ra) # 326 <write>
    if(i + 1 < argc){
  ...
  60:	2ca080e7          	jalr	714(ra) # 326 <write>
  for(i = 1; i < argc; i++){
  ...
  76:	2b4080e7          	jalr	692(ra) # 326 <write>
    }
  }
  exit(0);
  7a:	4501                	li	a0,0
  7c:	00000097          	auipc	ra,0x0
  80:	28a080e7          	jalr	650(ra) # 306 <exit>
...
gets(char *buf, int max)
{
 ...
 172:	1b0080e7          	jalr	432(ra) # 31e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1c4:	186080e7          	jalr	390(ra) # 346 <open>
  if(fd < 0)
 ...
 1d4:	18e080e7          	jalr	398(ra) # 35e <fstat>
 1d8:	892a                	mv	s2,a0
  close(fd);
 1da:	8526                	mv	a0,s1
 1dc:	00000097          	auipc	ra,0x0
 1e0:	152080e7          	jalr	338(ra) # 32e <close>
  return r;
}
 1e4:	854a                	mv	a0,s2
...
ugetpid(void)
{
 ...
 2f2:	17f5                	addi	a5,a5,-3 # 3fffffd <__global_pointer$+0x3ffef4c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fe:	4a650513          	addi	a0,a0,1190 # 8a0 <digits>
 402:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4be:	38ec8c93          	addi	s9,s9,910 # 848 <malloc+0x100>
 ...
 4cc:	3d8b8b93          	addi	s7,s7,984 # 8a0 <digits>
 ...
 5f2:	25298993          	addi	s3,s3,594 # 840 <malloc+0xf8>
        while(*s != 0){
 5f6:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6d4:	1e87b783          	ld	a5,488(a5) # 8b8 <freep>
 ...
 6fc:	00e6ea63          	bltu	a3,a4,710 <free+0x4a>
{
 ...
 73e:	16f73f23          	sd	a5,382(a4) # 8b8 <freep>
}
 742:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 770:	14c53503          	ld	a0,332(a0) # 8b8 <freep>
 ...
 798:	12490913          	addi	s2,s2,292 # 8b8 <freep>
  if(p == (char*)-1)
 79c:	5afd                	li	s5,-1
 79e:	a895                	j	812 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7a0:	00000797          	auipc	a5,0x0
 7a4:	12078793          	addi	a5,a5,288 # 8c0 <base>
 7a8:	00000717          	auipc	a4,0x0
 7ac:	10f73823          	sd	a5,272(a4) # 8b8 <freep>
 7b0:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d4:	0ea73423          	sd	a0,232(a4) # 8b8 <freep>
      return (void*)(p + 1);
 ...
 822:	b70080e7          	jalr	-1168(ra) # 38e <sbrk>
  if(p == (char*)-1)
